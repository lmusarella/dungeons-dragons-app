...
describe('src/features/character/companionsApi.js', () => {
  it('defines companions API surface', () => {
    const source = readFileSync('src/features/character/companionsApi.js', 'utf8');

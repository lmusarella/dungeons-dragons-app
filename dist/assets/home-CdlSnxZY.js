import{s as Ne,a as xe,b as ne,c as na,e as Ea,d as _e,R as ke,u as La,f as ia,g as Ma,h as Be,i as Na}from"./constants-CyQG1mJs.js";import{c as xa,g as oa,f as Ca,a as qa,b as Ra,d as Ba,e as za,h as Ta,m as Da,i as Ia,u as ja,j as Fa,k as Ha,l as Pa,n as Oa,o as Ae,p as Oe,q as Wa}from"./walletApi-DHU5tzoR.js";import{c as w,o as de,u as pe,a as ge,b as ze,g as te,n as ue,d as Ee,e as Le,s as We,f as Va,h as Ua,i as Ka,j as Ga}from"./index-DI--AiGI.js";import{openDiceOverlay as fe}from"./dice-9b6RHVbw.js";import{o as Ve}from"./characterDrawer-Cfz9jgcd.js";import{n as Q,c as $e,f as U,g as ce,a as Qa,b as Xa,d as Ya,e as me,h as la,s as Ja,i as Za,p as et,j as Ue,k as Te,l as Fe,r as at,m as tt,o as st,q as nt,t as it}from"./utils-Tv02vTp-.js";import{f as ot}from"./companionsApi-C9vuyJSp.js";import{s as Z,o as ra,a as lt,f as Ke,b as Ge,c as rt,d as ct,e as Qe,g as dt,r as ut,h as pt,i as mt,j as ft,k as Xe,l as bt,m as gt,n as vt}from"./modals-DPXLYvxf.js";function be(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function ht(e){const a=e&&typeof e=="object"?e:{};return{abilities:{str:10,dex:10,con:10,int:10,wis:10,cha:10,...a.abilities||{}},hp:{current:1,max:1,...a.hp||{}},speeds:{walk:null,fly:null,climb:null,burrow:null,...a.speeds||{}},attacks:Array.isArray(a.attacks)?a.attacks:[]}}function ca(e,a=[]){const t=(e==null?void 0:e.data)||{};if(!t.wild_shape_enabled)return null;const s=t.wild_shape||{};if(!s.active_companion_id)return null;const i=(a||[]).find(d=>String(d.id)===String(s.active_companion_id));if(!i)return null;const o=ht(i.stat_block),l=Math.max(Number(o.hp.max)||Number(o.hp.current)||1,1),r=Math.max(0,Math.min(Number(s.hp_current??o.hp.current??l)||0,l));return{companion:i,statBlock:o,hpCurrent:r,hpMax:l}}function _t(e={}){return[["walk","terra"],["fly","volo"],["climb","scalata"],["burrow","scavare"]].map(([t,s])=>Number(e==null?void 0:e[t])?`${s} ${Number(e[t])} m`:"").filter(Boolean).join(" · ")}function yt(e,a){return e?`
    <div>
  ...
  `,O=`Livello attuale: ${Y}`,G=Xa(i,r,t),B=!!i.darkvision_enabled,F=Q(i.darkvision_range_m),V=B?`${F??18} m`:"No",ee=(s||[]).filter(P=>["familiar","summon","transformation"].includes(P.kind||"familiar")),J=d?Math.min(Math.max(d.hpCurrent/d.hpMax*100,0),100):0,ie=d?_t(d.statBlock.speeds):"",qe=[{key:"str",label:ne.str,value:u.str,wild:!!d},{key:"dex",label:ne.dex,value:u.dex,wild:!!d},{key:"con",label:ne.con,value:u.con,wild:!!d},{key:"int",label:ne.int,value:r.int},{key:"wis",label:ne.wis,value:r.wis},{key:"cha",label:ne.cha,value:r.cha}];return`
  ...
  `}function St(e){const a=Array.isArray(e.special_skill_rolls)?e.special_skill_rolls:[];return a.some(i=>{const o=String((i==null?void 0:i.id)??"").toLowerCase(),l=String((i==null?void 0:i.name)??"").trim().toLowerCase();return o==="initiative"||o==="default_initiative"||l==="iniziativa"})?a:[{id:"default_initiative",name:"Iniziativa",ability:"dex",proficient:!1,mastery:!1,bonus:0},...a]}function wt(e){const a=e.data||{},t=a.abilities||{},s=Q(a.proficiency_bonus);return`
    <div class="detail-section">
      <div class="detail-grid detail-grid--compact">
        ${St(a).map((o,l)=>{var _;const r=ne[o.ability]?o.ability:"str",d=!!o.proficient,u=!!o.mastery&&d,m=$e(t[r],s,d?u?2:1:0),k=Number(o.bonus)||0,A=(m??0)+k,n=u?"modifier-card--mastery":d?"modifier-card--proficiency":"",E=((_=o.name)==null?void 0:_.trim())||`Tiro speciale ${l+1}`;return`
  ...
  `}function Mt(e,a=[],t=[]){var H;const s=e.data||{},i=Number(s.attack_bonus_melee??s.attack_bonus)||0,o=Number(s.attack_bonus_ranged??s.attack_bonus)||0,l=Number(s.damage_bonus_melee??s.damage_bonus)||0,r=Number(s.damage_bonus_ranged??s.damage_bonus)||0,d=Number(s.extra_attacks)||0,u=a.filter(g=>g.category==="weapon"&&g.equipable&&me(g).length),m=ca(e,t),A=(s.spellcasting||{}).ability,n=A?(H=s.abilities)==null?void 0:H[A]:null,E=ce(n),_=Q(s.proficiency_bonus),y=E===null||_===null?null:E+_,$=(Array.isArray(s.spells)?s.spells:[]).filter(g=>(g.kind==="cantrip"||Number(g.level)===0)&&g.attack_roll&&g.damage_die),q=$.length&&y!==null&&A;if(!u.length&&!q&&!(m!=null&&m.statBlock.attacks.length))return'<p class="muted">Nessuna arma equipaggiata.</p>';const v=[];d>0&&v.push(`Attacco Extra (${d})`),i&&v.push(`Mischia attacco ${U(i)}`),l&&v.push(`Mischia danni ${U(l)}`),o&&v.push(`Distanza attacco ${U(o)}`),r&&v.push(`Distanza danni ${U(r)}`);const D=v.length?`<div class="tag-row">${v.map(g=>`<span class="chip">${g}</span>`).join("")}</div>`:"";return`
    ...
    <div class="detail-section">
      <div class="detail-grid detail-grid--compact">
        ${m!=null&&m.statBlock.attacks.length?m.statBlock.attacks.map((g,N)=>{const S=g.name||`Attacco ${N+1}`,h=Number(g.damage_modifier)||0,I=`${g.damage||"-"}${h?` ${U(h)}`:""}`;return`
          <div class="modifier-card attack-card attack-card--wild-shape" data-roll-attack="wildshape:${N}">
            <div class="attack-card__body">
              <div class="attack-card__title">
                <strong class="attack-card__name">${be(S)}</strong>
            ...
            <div class="attack-card__actions">
              <button class="icon-button icon-button--fire" data-roll-damage="wildshape:${N}" aria-label="Calcola danni ${be(S)}">
                <span aria-hidden="true">🔥</span>
              </button>
            </div>
          </div>
        `}).join(""):""}
        ${u.map(g=>{var se;const N=g.weapon_range||(g.range_normal?"ranged":"melee"),S=g.attack_ability||(N==="ranged"?"dex":"str"),h=ce((se=s.abilities)==null?void 0:se[S])??0,I=s.proficiencies||{},W=(g.weapon_type==="simple"?!!I.weapon_simple:g.weapon_type==="martial"?!!I.weapon_martial:!1)?Q(s.proficiency_bonus)??0:0,X=N==="ranged"?o:i,ae=N==="ranged"?r:l,le=h+W+(Number(g.attack_modifier)||0)+X,Y=la(g).filter(K=>K.damageDie),c=Number(g.range_normal)||null,p=Number(g.range_disadvantage)||null,f=Number(g.melee_range)||1.5,b=[];N==="melee"&&f>1.5&&b.push(`Portata ${f} m`),N==="melee"&&g.is_thrown&&c&&b.push(`Lancio ${c}${p?`/${p}`:""}`),N!=="melee"&&c&&b.push(`Gittata ${c}${p?`/${p}`:""}`);const L=g.required_ammunition_type||g.ammunition_type,x=g.consumes_ammunition?a.filter(K=>K.category!=="container").filter(K=>L?K.ammunition_type===L:K.ammunition_type).reduce((K,Re)=>K+(Number(Re.qty)||0),0):null,C=za.get(L)||"Munizioni",M=x!==null?`${C} ${x}`:"",R=[...b,M].filter(Boolean).join(" · "),O=S==="dex"?"DES":S==="str"?"FOR":S.toUpperCase(),G=g.id??g.name,B=Y.length?Y:[{id:"default",label:"",damageDie:null,damageModifier:Number(g.damage_modifier)||0}],F=B.find(K=>K.id===g.selected_damage_mode)||B[0],V=h+(Number(F.damageModifier)||0)+ae,ee=F.damageDie?`${F.damageDie}${V?` ${U(V)}`:""}`:"-",J=F.id!=="default"?F.label:"",ie=J?`Impugnatura: ${J}`:"",qe=`weapon:${G}:${F.id}`,P=B.length>1?`<button class="icon-button icon-button--weapon-mode" data-cycle-weapon-mode="${G}" aria-label="Cambia impugnatura ${g.name}" title="Cambia impugnatura: ${J||F.label}"><span aria-hidden="true">🔁</span></button>`:"";return`
          <div class="modifier-card attack-card" data-roll-attack="weapon:${g.id??g.name}">
            <div class="attack-card__body">
              <div class="attack-card__title">
                <strong class="attack-card__name">${g.name}</strong>
                <span class="modifier-ability modifier-ability--${S}">${O}</span>
        ...
        `}).join("")}
        ${q?$.map(g=>{const N=Number(g.damage_modifier)||0,S=`${g.damage_die}${N?` ${U(N)}`:""}`,h=ne[A]??(A==null?void 0:A.toUpperCase()),I=g.range?`Range ${g.range}`:"";return`
  ...
  `}function Nt(e,a=!1){var S;const t=e.data||{},s=t.spell_notes||"",i=Array.isArray(t.spells)?Ja(t.spells):[],o=t.spellcasting||{},l=Q(t.proficiency_bonus),r=o.ability,d=r?(S=t.abilities)==null?void 0:S[r]:null,u=ce(d),m=u===null||l===null?null:8+u+l,k=u===null||l===null?null:u+l,A=r?ne[r]:null,n=o.slots||{},E=o.slots_max||{},_=o.recharge||"long_rest",z=Array.from({length:9},(h,I)=>I+1).map(h=>{const I=Math.max(0,Number(n[h])||0),j=Math.max(I,Number(E[h])||0);return{level:h,count:I,max:j}}).filter(h=>h.max>0),$=[`${A??"-"}`,`CD ${m===null?"-":m}`,`TC ${k===null?"-":U(k)}`],q=$.length?`<div class="tag-row">${$.map(h=>`<span class="chip">${h}</span>`).join("")}</div>`:"",v=i.filter(h=>{if((Number(h.level)||0)<1)return!1;const j=h.prep_state||"known";return j==="prepared"||j==="always"}),D=i.filter(h=>(Number(h.level)||0)===0),H=v.filter(h=>(h.prep_state||"known")==="always"),g=v.filter(h=>(h.prep_state||"known")!=="always"),N=(h,I="")=>{const j=Number(h.level)||0,W=Se(h.cast_time),X=da(W),ae=Te(h,j);return`
    ...
    <div class="home-layout">
      <div class="home-column home-column--left">
        ...
        <section class="card home-card home-section home-scroll-panel">
          ...
          <div class="home-scroll-body">
            ${v?wt(v):"<p>Nessun personaggio selezionato.</p>"}
          </div>
        </section>
      </div>
  ...
  `).join(""),s}function Xt(e){return{resistances:_e.filter(a=>e.has(`damage_resistance_${a.key}`)).map(a=>a.key),immunities:_e.filter(a=>e.has(`damage_immunity_${a.key}`)).map(a=>a.key)}}async function Yt(e){const{activeCharacter:a,canEditCharacter:t}=oe();if(!a||!t)return;const s=await de({title:"Resistenze & Immunità",submitLabel:"Salva",content:Qt(a),cardClass:"modal-card--wide"});s&&await Z(a,{...a.data,damage_defenses:Xt(s)},"Resistenze aggiornate",()=>{e&&T(e)})}async function Jt(e){const{activeCharacter:a}=oe(),t=te();if(!a)return;if(t.offline){w("Loot disponibile solo online.","error");return}const i=oa(a)==="kg"?"0.1":"1",o=await de({title:"Aggiungi loot rapido",submitLabel:"Aggiungi",content:Wa(i),onOpen:({fieldsEl:l})=>{Ka(l)}});if(o)try{await Ha({user_id:a.user_id,character_id:a.id,name:o.get("name"),qty:Number(o.get("qty")),weight:Number(o.get("weight")),volume:Number(o.get("volume"))||0,value_cp:Number(o.get("value_cp")),category:"loot",equipable:!1,equip_slot:null,equip_slots:[],sovrapponibile:!1,is_magic:!1,max_volume:null}),w("Loot aggiunto")}catch{w("Errore loot","error")}}function Ie(e,{min:a=null,max:t=null}={}){if(!(e instanceof HTMLInputElement)||e.type!=="number"||e.closest(".modal-value-stepper"))return;const s=document.createElement("div");s.className="number-stepper modal-value-stepper";const i=document.createElement("button");i.type="button",i.className="number-stepper__button modal-value-stepper__button",i.textContent="−",i.setAttribute("aria-label","Diminuisci valore");const o=document.createElement("button");o.type="button",o.className="number-stepper__button modal-value-stepper__button",o.textContent="+",o.setAttribute("aria-label","Aumenta valore");const l=e.parentNode;if(!l)return;l.insertBefore(s,e),s.append(i,e,o);const r=u=>Number.isFinite(u)?u:0,d=u=>{const m=r(e.valueAsNumber),k=Number(e.step),A=Number.isFinite(k)&&k>0?k:1;let n=m+A*u;const E=a??(e.min!==""?Number(e.min):null),_=t??(e.max!==""?Number(e.max):null);Number.isFinite(E)&&(n=Math.max(E,n)),Number.isFinite(_)&&(n=Math.min(_,n)),e.value=String(n),e.dispatchEvent(new Event("input",{bubbles:!0})),e.dispatchEvent(new Event("change",{bubbles:!0}))};i.addEventListener("click",()=>d(-1)),o.addEventListener("click",()=>d(1))}async function Zt(e,a){const{activeCharacter:t,canEditCharacter:s}=oe();if(!t)return;if(!s){w("Azioni denaro disponibili solo con profilo online","error");return}const i=te();let o=i.cache.wallet;if(!o&&!i.offline)try{o=await Ta(t.id),pe("wallet",o),o&&await ge({wallet:o})}catch{w("Errore caricamento wallet","error")}const d=await de({title:e==="pay"?"Paga monete":"Ricevi monete",submitLabel:e==="pay"?"Paga":"Ricevi",content:Da({direction:e}),onOpen:({fieldsEl:_})=>{const y=_==null?void 0:_.querySelector('input[name="amount"]');y&&Ie(y,{min:0})}});if(!d)return;o||(o={user_id:t.user_id,character_id:t.id,cp:0,sp:0,gp:0,pp:0});const u=d.get("coin"),m=Number(d.get("amount")||0),k={cp:u==="cp"?m:0,sp:u==="sp"?m:0,gp:u==="gp"?m:0,pp:u==="pp"?m:0},A=e==="pay"?-1:1,n=Object.fromEntries(Object.entries(k).map(([_,y])=>[_,y*A])),E=Ia(o,n);try{const _=await ja({...E,user_id:o.user_id,character_id:o.character_id});await Fa({user_id:o.user_id,character_id:o.character_id,direction:e,amount:n,reason:d.get("reason"),occurred_on:d.get("occurred_on")}),pe("wallet",_),await ge({wallet:_}),w("Wallet aggiornato"),a&&T(a)}catch{w("Errore aggiornamento denaro","error")}}const es=na.reduce((e,a)=>(e[a.key]=a.label,e),{}),ta={advantage:["invisibile"],disadvantage:["accecato","avvelenato","intralciato","prono","spaventato"]},sa={disadvantage:{dex:["intralciato"]},autoFail:{str:["paralizzato","privo_di_sensi","stordito"],dex:["paralizzato","privo_di_sensi","stordito"]}},fa=[{value:"",label:"Seleziona fonte"},{value:"situational",label:"Situazionale"},{value:"effect",label:"Effetto temporaneo"},{value:"condition",label:"Condizione"},{value:"armor",label:"Armatura"},{value:"racial",label:"Abilità razziale"},{value:"class",label:"Privilegio di classe"},{value:"spell",label:"Incantesimo"},{value:"item",label:"Oggetto magico/equipaggiamento"},{value:"other",label:"Altro"}];function we(e){const a=(e==null?void 0:e.data)||{};return Array.isArray(a.conditions)?a.conditions:a.condition?[a.condition]:[]}function ye(e){return e.map(a=>es[a]||a).filter(Boolean)}function ba(e=[]){return(e||[]).some(a=>a.category==="armor"&&a.armor_type==="heavy"&&a.equipable&&me(a).length)}function ga(e,a=[]){const t=(e==null?void 0:e.data)||{},i=(a||[]).filter(m=>m.category==="weapon"&&m.equipable&&me(m).length).map(m=>({key:`weapon:${m.id??m.name}`,label:m.name||"Arma"})),l=(Array.isArray(t.spells)?t.spells:[]).filter(m=>(m.kind==="cantrip"||Number(m.level)===0)&&m.attack_roll&&m.damage_die).map(m=>({key:`spell:${m.id}`,label:m.name||"Incantesimo"})),u=!!((t.spellcasting||{}).ability&&Q(t.proficiency_bonus)!==null)?[{key:"spell-attack",label:"Incantesimi"}]:[];return[...i,...l,...u]}function He(e){const a=we(e),t=ta.advantage.filter(o=>a.includes(o)),s=ta.disadvantage.filter(o=>a.includes(o)),i=[];return t.length&&i.push({mode:"advantage",source:"condition",reason:`Vantaggio: condizioni ${ye(t).join(", ")}.`}),s.length&&i.push({mode:"disadvantage",source:"condition",reason:`Svantaggio: condizioni ${ye(s).join(", ")}.`}),i}function va(e,a,t){const i=we(e).includes("avvelenato")?["avvelenato"]:[],o=ba(a),l=[];return i.length&&l.push({mode:"disadvantage",source:"condition",reason:`Svantaggio: condizioni ${ye(i).join(", ")}.`}),t.key==="stealth"&&o&&l.push({mode:"disadvantage",source:"armor",reason:"Svantaggio automatico: armatura pesante su Furtività."}),l}function as(e,a,t){const i=we(e).includes("avvelenato")?["avvelenato"]:[],o=ba(a),l=[];return i.length&&l.push({mode:"disadvantage",source:"condition",reason:`Svantaggio: condizioni ${ye(i).join(", ")}.`}),t==="dex"&&o&&l.push({mode:"disadvantage",source:"armor",reason:"Svantaggio automatico: armatura pesante su tiri speciali basati su DES."}),l}function ha(e,a){const t=ya(we(e),a.key);return t.rollMode?[{mode:t.rollMode,source:"condition",reason:t.rollModeReason}]:[]}function _a(e,a,t,s){return t==="attack_rolls"?He(e):t==="skills"?va(e,a,s):t==="saving_throws"?ha(e,s):[]}function ts(e){var a;return((a=fa.find(t=>t.value===e))==null?void 0:a.label)||e}function ve(e,a,t,s){var d,u,m,k;const i=(m=(u=(d=e==null?void 0:e.data)==null?void 0:d.roll_adjustments)==null?void 0:u[a])==null?void 0:m[t];if(!i||i.mode!=="advantage"&&i.mode!=="disadvantage")return null;const o=i.mode==="advantage"?"Vantaggio":"Svantaggio",l=(k=i.source)==null?void 0:k.toString().trim(),r=l?ts(l):"Situazionale";return{mode:i.mode,reason:`${o}: ${s} (${r}).`}}function re(e){const a=e.filter(Boolean),t=a.filter(i=>i.mode==="advantage").map(i=>i.reason).filter(Boolean),s=a.filter(i=>i.mode==="disadvantage").map(i=>i.reason).filter(Boolean);return t.length&&s.length?{rollMode:null,rollModeReason:`Vantaggio e svantaggio si annullano. ${[...t,...s].join(" ")}`}:t.length?{rollMode:"advantage",rollModeReason:t.join(" ")}:s.length?{rollMode:"disadvantage",rollModeReason:s.join(" ")}:{rollMode:null,rollModeReason:null}}function ya(e,a){const s=(sa.autoFail[a]||[]).filter(l=>e.includes(l));if(s.length)return{disabled:!0,disabledReason:`Condizioni: ${ye(s).join(", ")}`};const o=(sa.disadvantage[a]||[]).filter(l=>e.includes(l));return o.length?{rollMode:"disadvantage",rollModeReason:`Svantaggio: condizioni ${ye(o).join(", ")}.`}:{}}function $a(e,a=[]){const t=e.data||{},s=t.abilities||{},i=Q(t.proficiency_bonus),o=t.skills||{},l=t.skill_mastery||{};return xe.map(r=>{const d=!!o[r.key],u=!!l[r.key],m=$e(s[r.ability],i,d?u?2:1:0),k=m??0,A=va(e,a,r);A.push(ve(e,"skills",r.key,r.label));const n=re(A);return{value:r.key,label:`${r.label} (${U(m)})`,shortLabel:r.label,modifier:k,rollMode:n.rollMode,rollModeReason:n.rollModeReason}})}function ka(e,a=[]){const t=e.data||{},s=t.abilities||{},i=Q(t.proficiency_bonus),o=Array.isArray(t.special_skill_rolls)?t.special_skill_rolls:[];return(o.some(d=>{const u=String((d==null?void 0:d.id)??"").toLowerCase(),m=String((d==null?void 0:d.name)??"").trim().toLowerCase();return u==="initiative"||u==="default_initiative"||m==="iniziativa"})?o:[{id:"default_initiative",name:"Iniziativa",ability:"dex",proficient:!1,mastery:!1,bonus:0},...o]).map((d,u)=>{var q;const m=ne[d.ability]?d.ability:"str",k=!!d.proficient,A=!!d.mastery&&k,n=$e(s[m],i,k?A?2:1:0),E=Number(d.bonus)||0,_=(n??0)+E,y=((q=d.name)==null?void 0:q.trim())||`Tiro speciale ${u+1}`,z=as(e,a,m),$=re(z);return{value:String(d.id??u),label:`${y} (${U(_)})`,shortLabel:y,modifier:_,rollMode:$.rollMode,rollModeReason:$.rollModeReason}})}function Pe(e){const a=e.data||{},t=a.abilities||{},s=Q(a.proficiency_bonus),i=a.saving_throws||{},o=we(e);return Ne.map(l=>{const r=!!i[l.key],d=$e(t[l.key],s,r?1:0),u=d??0,m=ya(o,l.key),k=ve(e,"saving_throws",l.key,l.label),A=m.disabled?{rollMode:null,rollModeReason:null}:re([...ha(e,l),k]),n=m.disabled?" · fallimento diretto":"";return{value:l.key,label:`${l.label} (${U(d)})${n}`,shortLabel:ne[l.key]||l.label,modifier:u,rollMode:A.rollMode,rollModeReason:A.rollModeReason,disabled:m.disabled||!1,disabledReason:m.disabledReason||null}})}function Sa(e,a=[],t=[]){var q;const s=e.data||{},i=Number(s.attack_bonus_melee??s.attack_bonus)||0,o=Number(s.attack_bonus_ranged??s.attack_bonus)||0,l=(a||[]).filter(v=>v.category==="weapon"&&v.equipable&&me(v).length),r=Q(s.proficiency_bonus)??0,d=s.proficiencies||{},u=He(e),m=l.map(v=>{var X;const D=v.weapon_range||(v.range_normal?"ranged":"melee"),H=v.attack_ability||(D==="ranged"?"dex":"str"),g=ce((X=s.abilities)==null?void 0:X[H])??0,S=(v.weapon_type==="simple"?!!d.weapon_simple:v.weapon_type==="martial"?!!d.weapon_martial:!1)?r:0,h=D==="ranged"?o:i,I=g+S+(Number(v.attack_modifier)||0)+h,j=`weapon:${v.id??v.name}`,W=re([...u,ve(e,"attack_rolls",j,v.name)]);return{value:j,label:`${v.name} (${U(I)})`,shortLabel:v.name,modifier:I,rollMode:W.rollMode,rollModeReason:W.rollModeReason}}),k=Ce(e,t);k!=null&&k.statBlock.attacks.length&&k.statBlock.attacks.forEach((v,D)=>{const H=`wildshape:${D}`,g=re([...u,ve(e,"attack_rolls",H,v.name||`Attacco ${D+1}`)]);m.push({value:H,label:`${v.name||`Attacco ${D+1}`} (${U(v.to_hit||0)})`,shortLabel:v.name||`Attacco ${D+1}`,modifier:Number(v.to_hit)||0,rollMode:g.rollMode,rollModeReason:g.rollModeReason})});const n=(s.spellcasting||{}).ability,E=n?(q=s.abilities)==null?void 0:q[n]:null,_=ce(E),y=_===null||r===null?null:_+r,$=(Array.isArray(s.spells)?s.spells:[]).filter(v=>(v.kind==="cantrip"||Number(v.level)===0)&&v.attack_roll&&v.damage_die);return n&&y!==null&&$.forEach(v=>{const D=`spell:${v.id}`,H=re([...u,ve(e,"attack_rolls",D,v.name)]);m.push({value:D,label:`${v.name} (${U(y)})`,shortLabel:v.name,modifier:y,rollMode:H.rollMode,rollModeReason:H.rollModeReason})}),m}function ss(e){var m;const a=e.data||{},t=Q(a.proficiency_bonus),i=(a.spellcasting||{}).ability,o=i?(m=a.abilities)==null?void 0:m[i]:null,l=ce(o);if(!i||l===null||t===null)return[];const r=l+t,d="spell-attack",u=re([...He(e),ve(e,"attack_rolls",d,"Incantesimi")]);return[{value:d,label:`Incantesimi (${U(r)})`,shortLabel:"Incantesimi",modifier:r,rollMode:u.rollMode,rollModeReason:u.rollModeReason}]}function je(e){var a;return((a=_e.find(t=>t.key===e))==null?void 0:a.label)||e}function ns(e,a,t){var r;const s=Math.max(Number(a)||0,0);if(!t)return{amount:s,reason:null};const i=((r=e==null?void 0:e.data)==null?void 0:r.damage_defenses)||{},o=Array.isArray(i.resistances)?i.resistances:[],l=Array.isArray(i.immunities)?i.immunities:[];return l.includes("all")||l.includes(t)?{amount:0,reason:`immunità a ${je(t)}`}:o.includes("all")||o.includes(t)?{amount:Math.floor(s/2),reason:`resistenza a ${je(t)}`}:{amount:s,reason:null}}function wa(e,a){if(!(a!=null&&a.consumes_ammunition))return null;const t=a.required_ammunition_type||a.ammunition_type;return(e||[]).filter(s=>s.id!==a.id).filter(s=>s.category!=="container").filter(s=>!t||s.ammunition_type===t).filter(s=>Number(s.qty)>0).sort((s,i)=>String(s.name||"").localeCompare(String(i.name||""),"it",{sensitivity:"base"}))[0]||null}async function is(e,a){const t=wa(e,a);if(!t)return!1;const s=Math.max((Number(t.qty)||0)-1,0),i=await Ae(t.id,{qty:s}),l=(te().cache.items||[]).map(r=>String(r.id)===String(t.id)?{...r,...i||{},qty:s}:r);return pe("items",l),await ge({items:l}),w(`${t.name} consumato (${s} rimasti)`),!0}function os(e){var k,A,n;const{activeCharacter:a,sheetCharacter:t,canEditCharacter:s,companions:i}=oe();if(!a||!e)return;const o=te().cache.items||[],l=Sa(t||a,o,i),r=l.find(E=>E.value===e);if(!r)return;const d=e.startsWith("weapon:")?e.replace("weapon:",""):null,u=d?o.find(E=>String(E.id)===d||E.name===d):null;if(u!=null&&u.consumes_ammunition&&!wa(o,u)){w("Munizioni esaurite o non disponibili per questa arma.","error");return}let m=!1;he({title:`Tiro per Colpire • ${r.shortLabel||r.label}`,mode:"d20",rollType:"TC",selection:{label:"Attacco",options:l,value:r.value},allowInspiration:!!((k=a==null?void 0:a.data)!=null&&k.inspiration)&&s,weakPoints:Number((n=(A=a==null?void 0:a.data)==null?void 0:A.hp)==null?void 0:n.weak_points)||0,characterId:a.id,historyLabel:r.shortLabel||r.label,onRollComplete:async()=>{if(!(!(u!=null&&u.consumes_ammunition)||m)){m=!0;try{await is(te().cache.items||o,u)}catch{w("Errore consumo munizioni","error")}}}})}function Aa(e){var k,A,n,E,_;const{activeCharacter:a,sheetCharacter:t,companions:s,canEditCharacter:i}=oe(),o=te().cache.items||[],l=!!((k=a==null?void 0:a.data)!=null&&k.inspiration)&&i,r=Number((n=(A=a==null?void 0:a.data)==null?void 0:A.hp)==null?void 0:n.weak_points)||0,d=l&&a?async()=>{const y=a.data||{};y.inspiration&&await Z(a,{...y,inspiration:!1},"Ispirazione consumata",Me?()=>T(Me):null)}:null,m={"saving-throws":{title:"Tiro Salvezza",mode:"d20",rollType:"TS",selection:a?{label:"Tiro salvezza",options:Pe(t||a)}:null},skills:{title:"Tiro Abilità",mode:"d20",rollType:"TA",selection:a?{label:"Abilità",options:$a(t||a,o)}:null},"special-skills":{title:"Tiro Abilità Speciale",mode:"d20",rollType:"TA",selection:a?{label:"Abilità speciale",options:ka(t||a,o)}:null},"attack-roll":{title:"Tiro per Colpire",mode:"d20",rollType:"TC",selection:a?{label:"Attacco",options:Sa(t||a,o,s)}:null},"spell-attack":{title:"Tiro per Colpire Incantesimi",mode:"d20",rollType:"TC",selection:a?{label:"Incantesimi",options:ss(a)}:null},roller:{title:"Lancia Dadi generico",mode:"generic",rollType:"GEN"}}[e]??{title:"Lancia dadi",mode:"generic"};if(e==="spell-attack"&&!((_=(E=m.selection)==null?void 0:E.options)!=null&&_.length)){w("Configura abilità da incantatore e bonus competenza per usare questo tiro.","error");return}he({...m,allowInspiration:l,onConsumeInspiration:d,weakPoints:r,characterId:a==null?void 0:a.id})}async function ls(e,a){var i,o;const{activeCharacter:t}=oe();if(!(!t||!await ze({title:"Conferma riposo",message:e==="long_rest"?"Stai per effettuare un riposo lungo: risorse, slot e recuperi verranno aggiornati in base alle regole configurate.":"Stai per effettuare un riposo breve: verranno aggiornate solo le risorse che si recuperano con questo tipo di riposo.",confirmLabel:"Conferma riposo"})))try{await La(t.id,e),w(e==="long_rest"?"Riposo lungo completato":"Riposo breve completato");const r=await ia(t.id);pe("resources",r),await ge({resources:r});const d=tt(t.data,e);if(d?await Z(t,d,null,a?()=>T(a):null):a&&T(a),e==="long_rest"){const u=te().characters.find(m=>m.id===t.id);(o=(i=u==null?void 0:u.data)==null?void 0:i.spellcasting)!=null&&o.can_prepare&&await ra(u,a?()=>T(a):null)}}catch{w("Errore aggiornamento risorse","error")}}async function rs(e,a){var y,z,$,q,v,D,H,g;const{canEditCharacter:t}=oe();if(!e)return;if(!t){w("Azioni HP disponibili solo con profilo online","error");return}const s=((y=e.data)==null?void 0:y.hit_dice)||{},i=Number(s.used)||0,o=Number(s.max)||0,l=Math.max(o-i,0),r=Fe(s.die);if(!r){w("Configura un dado vita valido","error");return}if(l<=0){w("Nessun dado vita disponibile","error");return}const d=ce(($=(z=e.data)==null?void 0:z.abilities)==null?void 0:$.con)??0;let u=1;const k=await fe({keepOpen:!1,title:`Dado vita • ${s.die||`d${r}`}`,mode:"generic",notation:`1d${r}`,modifier:d,rollType:"GEN",characterId:e.id,historyLabel:"Dado vita",genericDiceMax:l,warning:"Attenzione: ogni dado vita lanciato verrà sottratto ai dadi vita disponibili.",onRollComplete:({diceCount:N})=>{u=Math.max(Number(N)||1,1)}}).waitForRoll;if(!k||k<=0)return;if(u>l){w(`Hai solo ${l} dadi vita disponibili`,"error");return}const A=Number((v=(q=e.data)==null?void 0:q.hp)==null?void 0:v.current)||0,n=(H=(D=e.data)==null?void 0:D.hp)==null?void 0:H.max,E=A+Number(k),_=n!=null?Math.min(E,Number(n)):E;await Z(e,{...e.data,hp:{...(g=e.data)==null?void 0:g.hp,current:_},hit_dice:{...s,used:Math.min(i+u,o)}},`PF curati +${k} (${u}d${r})`,()=>{a&&T(a)})}async function cs(e,a){var c,p,f,b,L,x,C,M,R,O,G;const{activeCharacter:t,canEditCharacter:s}=oe();if(!t)return;if(!s){w("Azioni HP disponibili solo con profilo online","error");return}const l=await de({title:e==="heal"?"Cura PF":"Subisci danno",submitLabel:e==="heal"?"Cura":"Danno",content:ds(t,{allowHitDice:!1,allowTempHp:e==="heal",allowMaxOverride:e==="damage"})});if(!l)return;const r=l.has("use_hit_dice"),d=l.has("temp_hp"),u=((c=t.data)==null?void 0:c.hit_dice)||{},m=((p=t.data)==null?void 0:p.abilities)||{},k=Number(u.used)||0,A=Number(u.max)||0,n=Fe(u.die),E=Math.max(Number(l.get("hit_dice_count"))||1,1);let _=Number(l.get("amount"));const y=_,z=e==="damage"&&((f=l.get("damage_type"))==null?void 0:f.toString())||"";if(e==="heal"&&r){if(!n){w("Configura un dado vita valido","error");return}if(k>=A){w("Nessun dado vita disponibile","error");return}const B=Math.max(A-k,0);if(E>B){w(`Hai solo ${B} dadi vita disponibili`,"error");return}const F=ce(m.con)??0,ee=Array.from({length:E},()=>at(n)).reduce((J,ie)=>J+ie,0);_=Math.max(ee+F*E,1)}if(!_||_<=0){w("Inserisci un valore valido","error");return}const $=e==="damage"?ns(t,_,z):{amount:_,reason:null};e==="damage"&&(_=$.amount);const q=Number((L=(b=t.data)==null?void 0:b.hp)==null?void 0:L.current)||0,v=Number((C=(x=t.data)==null?void 0:x.hp)==null?void 0:C.temp)||0,D=(R=(M=t.data)==null?void 0:M.hp)==null?void 0:R.max,H=l.get("hp_max_override"),g=H===null||H===""?null:Number(H);if(e==="damage"&&g!==null&&(!Number.isFinite(g)||g<=0)){w("Inserisci un massimo PF valido","error");return}let N=q,S=v;if(e==="heal"&&d)S=v+_;else if(e==="heal")N=q+_;else{const B=Math.min(v,_);S=v-B;const F=_-B;N=Math.max(q-F,0)}const h=g??D,I=h!=null?Math.min(N,Number(h)):N,j=e==="heal"&&r?{...u,used:Math.min(k+E,A)}:u,W=e==="damage"&&z?` ${je(z).toLowerCase()}`:"",X=e==="damage"&&$.reason?` (da ${y}, ${$.reason})`:"",ae=e==="heal"?`${d?"HP temporanei +":"PF curati +"}${_}${r?` (${E}d${n})`:""}`:`Danno${W} ${_}${X}`,le=e==="damage"&&Number(_)>0&&!!((O=t.data)!=null&&O.concentration_active),Y=async()=>{var V,ee,J;if(a&&T(a),!le)return;const B=Pe(t),F=B.find(ie=>ie.value==="con");!F||F.disabled||he({title:"Tiro salvezza concentrazione • COS",mode:"d20",rollType:"TS",selection:{label:"Tiro salvezza",options:B,value:F.value},allowInspiration:!!((V=t==null?void 0:t.data)!=null&&V.inspiration)&&s,weakPoints:Number((J=(ee=t==null?void 0:t.data)==null?void 0:ee.hp)==null?void 0:J.weak_points)||0,characterId:t.id,historyLabel:"TS concentrazione"})};await Z(t,{...t.data,hp:{...(G=t.data)==null?void 0:G.hp,current:I,temp:S,max:g??D},hit_dice:j},ae,Y)}function he({title:e,mode:a,selection:t=null,allowInspiration:s=!1,onConsumeInspiration:i=null,rollType:o=null,weakPoints:l=0,characterId:r=null,historyLabel:d=null,onRollComplete:u=null}){fe({keepOpen:!0,title:e,mode:a,selection:t,allowInspiration:s,onConsumeInspiration:i,rollType:o,weakPoints:l,characterId:r,historyLabel:d,onRollComplete:u})}function ds(e,{allowHitDice:a=!0,allowTempHp:t=!1,allowMaxOverride:s=!1}={}){var H,g,N;const i=(S,h={})=>{const I=S==null?void 0:S.querySelector('input[type="number"]');I&&Ga(I,h)},o=document.createElement("div");o.className="modal-form-grid hp-shortcut-fields";const l=Ee({label:"Valore",name:"amount",type:"number",value:"1"});l.classList.add("hp-shortcut-fields__amount");const r=l.querySelector("input");r&&Ie(r,{min:1}),r&&(r.min="1",r.required=!0);const d=document.createElement("div");if(d.className="modal-form-row modal-form-row--balanced hp-shortcut-fields__row",d.appendChild(l),t){const S=document.createElement("div");S.className="modal-toggle-field",S.innerHTML=`
    ...
    `,d.appendChild(S)}if(o.appendChild(d),!a){if(s){const S=document.createElement("label");S.className="field hp-shortcut-fields__damage-type";const h=document.createElement("span");h.textContent="Tipo di danno";const I=Le([{value:"",label:"Nessun tipo (danno normale)"},..._e.map(X=>({value:X.key,label:X.label}))],"");I.name="damage_type",S.append(h,I),d.appendChild(S);const j=Ee({label:"Nuovo massimo PF",name:"hp_max_override",type:"number",value:((g=(H=e==null?void 0:e.data)==null?void 0:H.hp)==null?void 0:g.max)??""});j.classList.add("hp-shortcut-fields__max");const W=j.querySelector("input");W&&(Ie(W,{min:1}),W.min="1"),d.appendChild(j)}return o}const u=((N=e==null?void 0:e.data)==null?void 0:N.hit_dice)||{},m=Number(u.used)||0,k=Number(u.max)||0,A=Math.max(k-m,0),n=Fe(u.die),E=A>0&&n,_=document.createElement("div");_.className="modal-toggle-field";const y=u.die?`${u.die}`:"dado vita";_.innerHTML=`
  ...
  `,i(z,{decrementLabel:"Riduci dadi vita",incrementLabel:"Aumenta dadi vita"});const $=document.createElement("div");if($.className="modal-form-row modal-form-row--balanced hp-shortcut-fields__row",$.append(_,z),o.appendChild($),!E){const S=document.createElement("p");S.className="muted",S.textContent="Nessun dado vita disponibile o configurato.",o.appendChild(S)}const q=_.querySelector("input"),v=z.querySelector("input");v&&(v.required=!1);const D=()=>{const S=q==null?void 0:q.checked;r&&(r.disabled=!!S,r.required=!S,S?r.value="":r.value||(r.value="1"),v&&(v.disabled=!S,v.required=!!S,S||(v.value="1")))};return q==null||q.addEventListener("change",D),D(),o}export{_s as bindGlobalFabHandlers,T as renderHome};

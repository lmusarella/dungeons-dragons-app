import{s as Be,a as ze,b as oe,c as ua,e as Ra,d as Se,R as Me,u as Ta,f as pa,g as Ba,h as Ie,i as za}from"./constants-D6OR7YMo.js";import{c as Da,g as ma,f as Ia,a as ja,b as Fa,d as Ha,e as Pa,h as Oa,m as Wa,i as Va,u as Ua,j as Ka,k as Ga,l as Qa,n as Xa,o as Ce,p as Xe,q as Ya}from"./walletApi-B7jn7vOV.js";import{c as A,o as ce,u as be,a as ye,b as je,g as te,n as fe,d as qe,e as Re,s as Ye,f as Ja,h as Za,i as et,j as at}from"./index-CEg3lb8Y.js";import{openDiceOverlay as he}from"./dice-B8F28esj.js";import{o as Je}from"./characterDrawer-CbfKQnJ0.js";import{g as We,a as Ve}from"./weaponMasteries-zUcl4F-E.js";import{n as X,c as Ee,f as V,g as me,a as tt,b as st,d as nt,e as ge,h as fa,s as it,i as ot,p as lt,j as Ze,k as Fe,l as Ue,r as rt,m as ct,o as dt,q as ut,t as pt}from"./utils-Tv02vTp-.js";import{f as mt}from"./companionsApi-CXpjZlKD.js";import{s as J,o as ba,a as ft,f as ea,b as aa,c as bt,d as gt,e as ta,g as vt,r as ht,h as _t,i as yt,j as $t,k as sa,l as kt,m as wt,n as St}from"./modals-wsuR4r1X.js";function _e(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function At(e){const a=e&&typeof e=="object"?e:{};return{abilities:{str:10,dex:10,con:10,int:10,wis:10,cha:10,...a.abilities||{}},hp:{current:1,max:1,...a.hp||{}},speeds:{walk:null,fly:null,climb:null,burrow:null,...a.speeds||{}},attacks:Array.isArray(a.attacks)?a.attacks:[]}}function ga(e,a=[]){const t=(e==null?void 0:e.data)||{};if(!t.wild_shape_enabled)return null;const s=t.wild_shape||{};if(!s.active_companion_id)return null;const i=(a||[]).find(c=>String(c.id)===String(s.active_companion_id));if(!i)return null;const o=At(i.stat_block),r=Math.max(Number(o.hp.max)||Number(o.hp.current)||1,1),l=Math.max(0,Math.min(Number(s.hp_current??o.hp.current??r)||0,r));return{companion:i,statBlock:o,hpCurrent:l,hpMax:r}}function Et(e={}){return[["walk","terra"],["fly","volo"],["climb","scalata"],["burrow","scavare"]].map(([t,s])=>Number(e==null?void 0:e[t])?`${s} ${Number(e[t])} m`:"").filter(Boolean).join(" · ")}function Mt(e,a){return e?`
    <div>

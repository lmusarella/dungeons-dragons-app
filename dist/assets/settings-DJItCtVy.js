import{g as z,n as _,j as I,e as k,c as h}from"./index-xCsXiwLa.js";async function L(e){var c,r,d,u,l,g;const{characters:o,activeCharacterId:v}=z(),f=_(v),a=o.find(n=>_(n.id)===f);if(!a){e.innerHTML='<section class="card"><p>Nessun personaggio selezionato.</p></section>';return}const s={encumbrance:((r=(c=a.data)==null?void 0:c.settings)==null?void 0:r.encumbrance)??"standard",weight_unit:((u=(d=a.data)==null?void 0:d.settings)==null?void 0:u.weight_unit)??"lb",auto_usage_dice:((g=(l=a.data)==null?void 0:l.settings)==null?void 0:g.auto_usage_dice)??!0};e.innerHTML=`
    <section class="card">
      <h2>Impostazioni</h2>

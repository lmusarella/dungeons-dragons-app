import{g as S,n as h,k as I,f as k,c as _}from"./index-DI--AiGI.js";async function D(t){var c,r,l,d,g,p;const{characters:o,activeCharacterId:b}=S(),f=h(b),a=o.find(i=>h(i.id)===f);if(!a){t.innerHTML='<section class="settings-view"><div class="card settings-shell"><p>Nessun personaggio selezionato.</p></div></section>';return}const s={encumbrance:((r=(c=a.data)==null?void 0:c.settings)==null?void 0:r.encumbrance)??"standard",weight_unit:((d=(l=a.data)==null?void 0:l.settings)==null?void 0:d.weight_unit)??"lb",auto_usage_dice:((p=(g=a.data)==null?void 0:g.settings)==null?void 0:p.auto_usage_dice)??!0};t.innerHTML=`

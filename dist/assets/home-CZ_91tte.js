import{s as Be,a as ze,b as ie,c as ca,e as Ca,d as ke,R as Ae,u as qa,f as da,g as Ra,h as Ie,i as Ta}from"./constants-CfIA4MDb.js";import{c as Ba,g as ua,f as za,a as Da,b as Ia,d as Fa,e as ja,h as Pa,m as Ha,i as Oa,u as Wa,j as Va,k as Ua,l as Ka,n as Ga,o as Ce,p as Ge,q as Qa}from"./walletApi-B87Ywbnz.js";import{c as w,o as ue,u as me,a as he,b as Fe,g as se,n as pe,d as qe,e as Re,s as Qe,f as Xa,h as Ya,i as Ja,j as Za}from"./index-Dzi-oHcd.js";import{openDiceOverlay as ge}from"./dice-CuI9_8Y4.js";import{o as Xe}from"./characterDrawer-CxaURO8e.js";import{n as X,c as we,f as U,g as de,a as et,b as at,d as tt,e as fe,h as pa,s as st,i as nt,p as it,j as Ye,k as je,l as We,r as ot,m as lt,o as rt,q as ct,t as dt}from"./utils-Tv02vTp-.js";import{f as ut}from"./companionsApi-BfDo3NX_.js";import{s as ae,o as ma,a as pt,f as Je,b as Ze,c as mt,d as ft,e as ea,g as bt,r as gt,h as vt,i as ht,j as _t,k as aa,l as yt,m as $t,n as kt}from"./modals-B7op7Kez.js";function ve(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function St(e){const a=e&&typeof e=="object"?e:{};return{abilities:{str:10,dex:10,con:10,int:10,wis:10,cha:10,...a.abilities||{}},hp:{current:1,max:1,...a.hp||{}},speeds:{walk:null,fly:null,climb:null,burrow:null,...a.speeds||{}},attacks:Array.isArray(a.attacks)?a.attacks:[]}}function fa(e,a=[]){const t=(e==null?void 0:e.data)||{};if(!t.wild_shape_enabled)return null;const s=t.wild_shape||{};if(!s.active_companion_id)return null;const n=(a||[]).find(c=>String(c.id)===String(s.active_companion_id));if(!n)return null;const o=St(n.stat_block),r=Math.max(Number(o.hp.max)||Number(o.hp.current)||1,1),l=Math.max(0,Math.min(Number(s.hp_current??o.hp.current??r)||0,r));return{companion:n,statBlock:o,hpCurrent:l,hpMax:r}}function wt(e={}){return[["walk","terra"],["fly","volo"],["climb","scalata"],["burrow","scavare"]].map(([t,s])=>Number(e==null?void 0:e[t])?`${s} ${Number(e[t])} m`:"").filter(Boolean).join(" · ")}function At(e,a){return e?`
    <div>
          ...
          <div class="hp-bar-stack">
            ...
            <div class="hp-bar-track hp-bar-track--wild-shape">
              <div class="hp-bar hp-bar--wild-shape">
                <div class="hp-bar__fill hp-bar__fill--wild-shape" style="width: ${Z}%;"></div>
              </div>

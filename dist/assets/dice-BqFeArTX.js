import{j as ut,n as Kt}from"./index-ChvAnTk7.js";let Ee=null;const Jt=["/dungeons-dragons-app/libs/three.min.js","/dungeons-dragons-app/libs/cannon.min.js","/dungeons-dragons-app/libs/teal.js","/dungeons-dragons-app/dice-roller/dice.js","/dungeons-dragons-app/dice-roller/main.js"];function Yt(i){return new Promise((l,c)=>{const r=document.querySelector(`script[data-legacy-dice="${i}"]`);if((r==null?void 0:r.dataset.loaded)==="true")return l();if(r){r.addEventListener("load",()=>l(),{once:!0}),r.addEventListener("error",()=>c(new Error(`Impossibile caricare ${i}`)),{once:!0});return}const p=document.createElement("script");p.src=i,p.async=!1,p.dataset.legacyDice=i,p.addEventListener("load",()=>{p.dataset.loaded="true",l()},{once:!0}),p.addEventListener("error",()=>c(new Error(`Impossibile caricare ${i}`)),{once:!0}),document.body.appendChild(p)})}function Qt(){return window.main&&typeof window.main.init=="function"?Promise.resolve():(Ee||(Ee=Jt.reduce((i,l)=>i.then(()=>Yt(l)),Promise.resolve())),Ee)}let a=null,H=null,Z=0,ft=!1;function Zt(){return`

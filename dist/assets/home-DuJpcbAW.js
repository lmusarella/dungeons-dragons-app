import{s as Be,a as ze,b as oe,c as ua,e as Ra,d as Se,R as Me,u as Ta,f as pa,g as Ba,h as Ie,i as za}from"./constants-BazOa3I2.js";import{c as Da,g as ma,f as Ia,a as ja,b as Fa,d as Ha,e as Pa,h as Oa,m as Wa,i as Va,u as Ua,j as Ka,k as Ga,l as Qa,n as Xa,o as Ce,p as Xe,q as Ya}from"./walletApi-Tx-8zgS8.js";import{c as A,o as ce,u as be,a as ye,b as je,g as te,n as fe,d as qe,e as Re,s as Ye,f as Ja,h as Za,i as et,j as at}from"./index-ChvAnTk7.js";import{openDiceOverlay as he}from"./dice-BqFeArTX.js";import{o as Je}from"./characterDrawer-CsuhPsct.js";import{g as We,a as Ve}from"./weaponMasteries-zUcl4F-E.js";import{n as X,c as Ee,f as V,g as me,a as tt,b as st,d as nt,e as ge,h as fa,s as it,i as ot,p as lt,j as Ze,k as Fe,l as Ue,r as rt,m as ct,o as dt,q as ut,t as pt}from"./utils-Tv02vTp-.js";import{f as mt}from"./companionsApi-CJPRN_IJ.js";import{s as J,o as ba,a as ft,f as ea,b as aa,c as bt,d as gt,e as ta,g as vt,r as ht,h as _t,i as yt,j as $t,k as sa,l as kt,m as wt,n as St}from"./modals-DmjWyOlV.js";function _e(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function At(e){const a=e&&typeof e=="object"?e:{};return{abilities:{str:10,dex:10,con:10,int:10,wis:10,cha:10,...a.abilities||{}},hp:{current:1,max:1,...a.hp||{}},speeds:{walk:null,fly:null,climb:null,burrow:null,...a.speeds||{}},attacks:Array.isArray(a.attacks)?a.attacks:[]}}function ga(e,a=[]){const t=(e==null?void 0:e.data)||{};if(!t.wild_shape_enabled)return null;const s=t.wild_shape||{};if(!s.active_companion_id)return null;const n=(a||[]).find(c=>String(c.id)===String(s.active_companion_id));if(!n)return null;const o=At(n.stat_block),r=Math.max(Number(o.hp.max)||Number(o.hp.current)||1,1),l=Math.max(0,Math.min(Number(s.hp_current??o.hp.current??r)||0,r));return{companion:n,statBlock:o,hpCurrent:l,hpMax:r}}function Et(e={}){return[["walk","terra"],["fly","volo"],["climb","scalata"],["burrow","scavare"]].map(([t,s])=>Number(e==null?void 0:e[t])?`${s} ${Number(e[t])} m`:"").filter(Boolean).join(" · ")}function Mt(e,a){return e?`
    <div>
  ...
  `:`<p class="muted">${a?"Modalità offline attiva: crea un personaggio quando torni online.":"Accedi per creare un personaggio."}</p>`}function Lt(e,a,t=[],s=[]){const n=e.data||{},o=n.hp||{},r=n.hit_dice||{},l=n.abilities||{},c=ga(e,s),u=c?{...l,str:Math.max(Number(l.str)||0,Number(c.statBlock.abilities.str)||0),dex:Math.max(Number(l.dex)||0,Number(c.statBlock.abilities.dex)||0),con:Math.max(Number(l.con)||0,Number(c.statBlock.abilities.con)||0)}:l,p=X(n.proficiency_bonus),$=!!n.inspiration,y=!!n.concentration_active,i=n.initiative??me(u.dex),E=n.skills||{},w=n.skill_mastery||{},k=tt(u,p,E,w),B=X(o.current),g=X(o.max),q=X(o.temp),v=n.death_saves||{},T=Math.max(0,Math.min(3,Number(v.successes)||0)),F=Math.max(0,Math.min(3,Number(v.failures)||0)),h=g?Math.min(Math.max(Number(B)/g*100,0),100):0,N=Math.max(0,Number(q)||0),S=Math.max(0,Number(g??B??0)),_=N>0,D=_?100:0,I=_?S:1,O=_?N:0,K=g?`${B??"-"}/${g}`:`${B??"-"}`,Z=g?`${Math.round(h)}%`:"-",ue=q??"-",Y=Math.max(0,Math.min(6,Number(o.weak_points)||0)),d=Array.isArray(n.conditions)?n.conditions:n.condition?[n.condition]:[],m=ua.filter(P=>d.includes(P.key)),f=m.length?m.map(P=>P.label).join(", "):"Nessuna condizione",L=`
  ...
  `}function Nt(e){const a=e.data||{},t=a.abilities||{},s=X(a.proficiency_bonus),n=a.skills||{},o=a.skill_mastery||{};return`
    <div class="detail-section">
      <div class="detail-grid detail-grid--compact">
        ${ze.map(r=>{const l=!!n[r.key],c=!!o[r.key],u=Ee(t[r.ability],s,l?c?2:1:0);return`
  ...
  `}function xt(e){const a=Array.isArray(e.special_skill_rolls)?e.special_skill_rolls:[];return a.some(n=>{const o=String((n==null?void 0:n.id)??"").toLowerCase(),r=String((n==null?void 0:n.name)??"").trim().toLowerCase();return o==="initiative"||o==="default_initiative"||r==="iniziativa"})?a:[{id:"default_initiative",name:"Iniziativa",ability:"dex",proficient:!1,mastery:!1,bonus:0},...a]}function Ct(e){const a=e.data||{},t=a.abilities||{},s=X(a.proficiency_bonus);return`
    <div class="detail-section">
      <div class="detail-grid detail-grid--compact">
        ${xt(a).map((o,r)=>{var w;const l=oe[o.ability]?o.ability:"str",c=!!o.proficient,u=!!o.mastery&&c,p=Ee(t[l],s,c?u?2:1:0),$=Number(o.bonus)||0,y=(p??0)+$,i=u?"modifier-card--mastery":c?"modifier-card--proficiency":"",E=((w=o.name)==null?void 0:w.trim())||`Tiro speciale ${r+1}`;return`
  ...
  `}function qt(e){const a=e.data||{},t=a.abilities||{},s=X(a.proficiency_bonus),n=a.saving_throws||{};return`
    <div class="detail-section">
      <div class="detail-grid detail-grid--compact">
        ${Be.map(o=>{const r=!!n[o.key],l=Ee(t[o.key],s,r?1:0);return`
  ...
  `}function na(e,a){const s=(Array.isArray(e==null?void 0:e[a])?e[a]:[]).map(n=>{var o;return((o=Se.find(r=>r.key===n))==null?void 0:o.label)||n}).filter(Boolean);return s.length?`<div class="tag-row">${s.map(n=>`<span class="chip chip--defense">${n}</span>`).join("")}</div>`:'<p class="muted">Nessuna voce configurata.</p>'}function Rt(e,a=[],t=!1){const s=e.data||{},n=s.proficiencies||{},o=s.proficiency_notes||"",{tools:r,languages:l}=lt(o),c=s.language_proficiencies||"",u=Ze(c),p=s.talents||"",$=Ze(p),y=s.damage_defenses||{},E=[...u,...l].reduce((g,q)=>{const v=q.trim();if(!v)return g;const T=v.toLowerCase();return g.seen.has(T)||(g.seen.add(T),g.values.push(v)),g},{values:[],seen:new Set}).values,w=Ra.filter(g=>n[g.key]).map(g=>g.label),k=s.weapon_mastery_enabled||Array.isArray(s.weapon_masteries)&&s.weapon_masteries.length>0?Array.isArray(s.weapon_masteries)?s.weapon_masteries:[]:[],B=k.length>0||!!s.weapon_mastery_enabled;return`
    <div class="detail-section">
  ...
  `}function Tt(e,a=[],t=!1){const s=(a||[]).filter(l=>ge(l).length),n=(a||[]).filter(l=>l.attunement_active).length,o=Da(a),r=ma(e);return`
  ...
  `}function Bt(e,a=[],t=[]){var F;const s=e.data||{},n=Number(s.attack_bonus_melee??s.attack_bonus)||0,o=Number(s.attack_bonus_ranged??s.attack_bonus)||0,r=Number(s.damage_bonus_melee??s.damage_bonus)||0,l=Number(s.damage_bonus_ranged??s.damage_bonus)||0,c=Number(s.extra_attacks)||0,u=a.filter(h=>h.category==="weapon"&&h.equipable&&ge(h).length),p=ga(e,t),y=(s.spellcasting||{}).ability,i=y?(F=s.abilities)==null?void 0:F[y]:null,E=me(i),w=X(s.proficiency_bonus),k=E===null||w===null?null:E+w,g=(Array.isArray(s.spells)?s.spells:[]).filter(h=>(h.kind==="cantrip"||Number(h.level)===0)&&h.attack_roll&&h.damage_die),q=g.length&&k!==null&&y;if(!u.length&&!q&&!(p!=null&&p.statBlock.attacks.length))return'<p class="muted">Nessuna arma equipaggiata.</p>';const v=[];c>0&&v.push(`Attacco Extra (${c})`),n&&v.push(`Mischia attacco ${V(n)}`),r&&v.push(`Mischia danni ${V(r)}`),o&&v.push(`Distanza attacco ${V(o)}`),l&&v.push(`Distanza danni ${V(l)}`);const T=v.length?`<div class="tag-row">${v.map(h=>`<span class="chip">${h}</span>`).join("")}</div>`:"";return`
  ...
  `}function zt(e,a=!1){var S;const t=e.data||{},s=t.spell_notes||"",n=Array.isArray(t.spells)?it(t.spells):[],o=t.spellcasting||{},r=X(t.proficiency_bonus),l=o.ability,c=l?(S=t.abilities)==null?void 0:S[l]:null,u=me(c),p=u===null||r===null?null:8+u+r,$=u===null||r===null?null:u+r,y=l?oe[l]:null,i=o.slots||{},E=o.slots_max||{},w=o.recharge||"long_rest",B=Array.from({length:9},(_,D)=>D+1).map(_=>{const D=Math.max(0,Number(i[_])||0),I=Math.max(D,Number(E[_])||0);return{level:_,count:D,max:I}}).filter(_=>_.max>0),g=[`${y??"-"}`,`CD ${p===null?"-":p}`,`TC ${$===null?"-":V($)}`],q=g.length?`<div class="tag-row">${g.map(_=>`<span class="chip">${_}</span>`).join("")}</div>`:"",v=n.filter(_=>{if((Number(_.level)||0)<1)return!1;const I=_.prep_state||"known";return I==="prepared"||I==="always"}),T=n.filter(_=>(Number(_.level)||0)===0),F=v.filter(_=>(_.prep_state||"known")==="always"),h=v.filter(_=>(_.prep_state||"known")!=="always"),N=(_,D="")=>{const I=Number(_.level)||0,O=Le(_.cast_time),K=va(O),Z=Fe(_,I);return`
  ...
  `}function Le(e){const a=e==null?void 0:e.toString().trim();if(!a)return"";const t=a.toLowerCase();if(t.includes("bonus"))return"Azione Bonus";if(t.includes("reaz"))return"Reazione";if(t.includes("gratuit"))return"Azione Gratuita";if(t.includes("durata")||t.includes("più")||t.includes("piu")||t.includes("superiore"))return"Durata";if(t.includes("azion"))return"Azione";const s=Me.find(n=>n.label.toLowerCase()===t);return(s==null?void 0:s.label)??""}function ia(e){if(!e)return Me.length;const a=Le(e),t=Me.findIndex(s=>s.label===a);return t===-1?Me.length:t}function va(e){var t;if(!e)return"";const a=Le(e);return((t=Me.find(s=>s.label===a))==null?void 0:t.className)??""}function Dt(e){return[...e].sort((a,t)=>{const s=ia(a.cast_time)-ia(t.cast_time);return s!==0?s:(a.name??"").localeCompare(t.name??"","it",{sensitivity:"base"})})}function oa(e,a,{showCharges:t=!0,showUseButton:s=!0,showDescription:n=!1,showCastTime:o=!0}={}){return`
  ...
  `}function It(e,a){if(!e.length)return"<p>Nessuna risorsa.</p>";const t=Dt(e),s=t.filter(l=>l.reset_on===null||l.reset_on==="none"),n=t.filter(l=>l.reset_on!==null&&l.reset_on!=="none"),o=`
    <details class="resource-accordion resource-section resource-section--active" open>
      ...
      <div class="resource-section__body resource-accordion__body">
        ${n.length?oa(n,a,{showUseButton:!0}):'<p class="muted">Nessuna risorsa attiva.</p>'}
      </div>
    </details>
  `,r=`
    ...
    <div class="home-layout">
      ...
      <div class="home-column home-column--right">
        <section class="card home-card home-section home-scroll-panel">
          ...
          <div class="home-scroll-body">
            ${i?Bt(v,g||[],q):"<p>Nessun personaggio selezionato.</p>"}
          </div>
        </section>
        ...
        <section class="card home-card home-section home-scroll-panel">
          ...
          <div class="home-scroll-body home-scroll-body--resources">
            ${i?It(B,w):"<p>Nessun personaggio selezionato.</p>"}
            ${i&&!w?'<p class="muted">Connettiti per aggiungere nuove risorse.</p>':""}
          </div>
        </section>
      </div>
    </div>
  `,ha();const T=e.querySelector("[data-create-character]");T&&T.addEventListener("click",()=>{Je(s,()=>z(e))});const F=e.querySelector("[data-edit-character]");F&&F.addEventListener("click",()=>{Je(s,()=>z(e),i)});const h=e.querySelector("[data-add-resource]");h&&h.addEventListener("click",()=>{aa(i,()=>z(e))});const N=e.querySelector("[data-add-spell]");N&&N.addEventListener("click",async()=>{var m;if(!i)return;const d=await bt();if(d){if(d==="shared")try{const f=await Kt();if(!f)return;const b=Vt(f),L=Array.isArray((m=i.data)==null?void 0:m.spells)?i.data.spells:[];if(L.some(M=>M.shared_spell_id===f.id)){A("Incantesimo già presente nella scheda personaggio","info");return}i.user_id&&await gt({user_id:i.user_id,character_id:i.id,shared_spell_id:f.id,prep_state:b.prep_state});const C={...i.data||{},spells:[...L,b]};await J(i,C,"Incantesimo aggiunto dalla lista condivisa",()=>z(e));return}catch{A("Errore durante l'associazione dell'incantesimo condiviso","error");return}ta(i,async f=>{if(!f)return z(e);try{await vt({created_by:i.user_id,rules_version:f.rules_version||"2024",name:f.name,level:f.level,school:f.school||null,caster_classes:Array.isArray(f.caster_classes)?f.caster_classes:[],cast_time:f.cast_time||null,range:f.range||null,duration:f.duration||null,components:f.components||null,concentration:!!f.concentration,ritual:!!f.is_ritual,attack_roll:!!f.attack_roll,damage_die:f.damage_die||null,damage_modifier:f.damage_modifier??null,upcast_damage_die:f.upcast_damage_die||null,upcast_damage_modifier:f.upcast_damage_modifier??null,upcast_start_level:f.upcast_start_level??null,description:f.description||null})}catch{A("Incantesimo salvato sul personaggio ma non sul catalogo condiviso","info")}z(e)})}}),e.querySelectorAll("[data-edit-spell]").forEach(d=>d.addEventListener("click",()=>{var L;const m=d.dataset.editSpell;if(!m||!i)return;const b=(Array.isArray((L=i.data)==null?void 0:L.spells)?i.data.spells:[]).find(x=>x.id===m);b&&ta(i,()=>z(e),b)})),e.querySelectorAll("[data-delete-spell]").forEach(d=>d.addEventListener("click",async()=>{var C;const m=d.dataset.deleteSpell;if(!m||!i)return;const f=Array.isArray((C=i.data)==null?void 0:C.spells)?i.data.spells:[],b=f.find(M=>M.id===m);if(!b||!await je({title:"Conferma eliminazione incantesimo",message:`Stai per eliminare l'incantesimo "${b.name}" dalla scheda del personaggio. Questa azione non può essere annullata.`,confirmLabel:"Elimina"}))return;if(b.shared_spell_id)try{const R=(await ea(i.id)).find(W=>W.shared_spell_id===b.shared_spell_id);R!=null&&R.id&&await ht(R.id)}catch{A("Errore rimozione associazione incantesimo","error");return}const x={...i.data||{},spells:f.filter(M=>M.id!==b.id)};await J(i,x,"Incantesimo eliminato",()=>z(e))}));const S=e.querySelector("[data-open-prepared-spells]");S&&S.addEventListener("click",()=>{ba(i,()=>z(e))}),e.querySelectorAll("[data-spell-quick-open]").forEach(d=>d.addEventListener("click",()=>{var L;const m=d.dataset.spellQuickOpen;if(!m||!i)return;const b=(Array.isArray((L=i.data)==null?void 0:L.spells)?i.data.spells:[]).find(x=>x.id===m);b&&_t(i,b,()=>z(e))}));const _=e.querySelector("[data-show-background]");_&&_.addEventListener("click",()=>{yt(i)});const D=e.querySelector("[data-edit-conditions]");D&&D.addEventListener("click",async()=>{await _a(e)}),e.querySelectorAll("[data-proficiency-tabs]").forEach(d=>{var x;const m=Array.from(d.querySelectorAll("[data-proficiency-tab]")),f=Array.from(d.querySelectorAll("[data-proficiency-panel]"));if(!m.length||!f.length)return;const b=C=>{m.forEach(M=>{const R=M.dataset.proficiencyTab===C;M.classList.toggle("is-active",R),M.setAttribute("aria-selected",String(R))}),f.forEach(M=>{M.classList.toggle("is-active",M.dataset.proficiencyPanel===C)})};m.forEach(C=>{C.addEventListener("click",()=>{b(C.dataset.proficiencyTab)})});const L=((x=m.find(C=>C.classList.contains("is-active")))==null?void 0:x.dataset.proficiencyTab)??m[0].dataset.proficiencyTab;L&&b(L)});const I=e.querySelector("[data-add-equip]");I&&i&&k&&I.addEventListener("click",async()=>{var G;const d=(g||[]).filter(j=>j.equipable&&!ge(j).length);if(!d.length){A("Nessun oggetto equipaggiabile disponibile","error");return}const m=document.createElement("div");m.className="drawer-form";const f=document.createElement("label");f.className="field",f.innerHTML="<span>Oggetto</span>";const b=document.createElement("select");b.name="item_id",d.forEach(j=>{const H=document.createElement("option");H.value=j.id,H.textContent=j.name,b.appendChild(H)}),f.appendChild(b),m.appendChild(f);const L=document.createElement("fieldset");L.className="equip-slot-field",L.innerHTML="<legend>Punti del corpo</legend>";const x=document.createElement("div");x.className="equip-slot-list",Xa.forEach(j=>{const H=document.createElement("label");H.className="checkbox",H.innerHTML=`<input type="checkbox" name="equip_slots" value="${j.value}" /> <span>${j.label}</span>`,x.appendChild(H)}),L.appendChild(x),m.appendChild(L);const C=await ce({title:"Equipaggia oggetto",submitLabel:"Equipaggia",content:m});if(!C)return;const M=C.getAll("equip_slots");if(!M.length){A("Seleziona almeno uno slot","error");return}const R=d.find(j=>String(j.id)===C.get("item_id"));if(!R)return;const W=((G=i.data)==null?void 0:G.proficiencies)||{};if(R.category==="weapon"){if(!R.weapon_type){A("Definisci il tipo di arma prima di equipaggiarla","error");return}if(!(R.weapon_type==="simple"?!!W.weapon_simple:!!W.weapon_martial)){A("Non hai la competenza per equipaggiare questo oggetto","error");return}}if(R.category==="armor")if(R.is_shield){if(!W.shield){A("Non hai la competenza per equipaggiare questo oggetto","error");return}}else if(R.armor_type){if(!(R.armor_type==="light"?!!W.armor_light:R.armor_type==="medium"?!!W.armor_medium:!!W.armor_heavy)){A("Non hai la competenza per equipaggiare questo oggetto","error");return}}else{A("Definisci il tipo di armatura prima di equipaggiarla","error");return}if(!R.sovrapponibile&&(g||[]).filter(H=>H.id!==R.id).filter(H=>ge(H).some(U=>M.includes(U))).length){A("Uno o più slot selezionati sono già occupati","error");return}try{await Ce(R.id,{equip_slot:M[0]||null,equip_slots:M}),A("Equipaggiamento aggiornato"),z(e)}catch{A("Errore aggiornamento equip","error")}}),e.querySelectorAll("[data-unequip]").forEach(d=>d.addEventListener("click",async()=>{const m=(g||[]).find(f=>f.id===d.dataset.unequip);if(m)try{await Ce(m.id,{equip_slot:null,equip_slots:[]}),A("Equipaggiamento rimosso"),z(e)}catch{A("Errore aggiornamento equip","error")}}));const O=e.querySelector("[data-toggle-inspiration]");O&&i&&k&&O.addEventListener("click",async()=>{const d=i.data||{},m={...d,inspiration:!d.inspiration};await J(i,m,"Ispirazione aggiornata",()=>z(e))});const K=e.querySelector("[data-toggle-concentration]");K&&i&&k&&K.addEventListener("click",async()=>{const d=i.data||{},m={...d,concentration_active:!d.concentration_active};await J(i,m,"Concentrazione aggiornata",()=>z(e))}),e.querySelectorAll("[data-open-wild-shape]").forEach(d=>d.addEventListener("click",()=>{!i||!k||Ht(i,q,e)})),e.querySelectorAll("[data-end-wild-shape]").forEach(d=>d.addEventListener("click",()=>{!i||!k||Pt(i,e)})),e.querySelectorAll("[data-open-dice]").forEach(d=>d.addEventListener("click",()=>{Ca(d.dataset.openDice)})),e.querySelectorAll("[data-saving-throw-card]").forEach(d=>d.addEventListener("click",()=>{var L,x,C;if(!i)return;const m=d.dataset.savingThrowCard;if(!m)return;const f=Qe(i),b=f.find(M=>M.value===m);b&&we({title:`Tiro salvezza • ${b.shortLabel||b.label}`,mode:"d20",rollType:"TS",selection:{label:"Tiro salvezza",options:f,value:b.value},allowInspiration:!!((L=i==null?void 0:i.data)!=null&&L.inspiration)&&k,weakPoints:Number((C=(x=i==null?void 0:i.data)==null?void 0:x.hp)==null?void 0:C.weak_points)||0,characterId:i.id})})),e.querySelectorAll("[data-skill-card]").forEach(d=>d.addEventListener("click",()=>{var L,x,C;if(!i)return;const m=d.dataset.skillCard;if(!m)return;const f=Ma(i,g||[]),b=f.find(M=>M.value===m);b&&we({title:`Tiro abilità • ${b.shortLabel||b.label}`,mode:"d20",rollType:"TA",selection:{label:"Abilità",options:f,value:b.value},allowInspiration:!!((L=i==null?void 0:i.data)!=null&&L.inspiration)&&k,weakPoints:Number((C=(x=i==null?void 0:i.data)==null?void 0:x.hp)==null?void 0:C.weak_points)||0,characterId:i.id})})),e.querySelectorAll("[data-special-skill-card]").forEach(d=>d.addEventListener("click",()=>{var L,x,C;if(!i)return;const m=d.dataset.specialSkillCard;if(!m)return;const f=La(i,g||[]),b=f.find(M=>M.value===m);b&&we({title:`Tiro abilità speciale • ${b.shortLabel||b.label}`,mode:"d20",rollType:"TA",selection:{label:"Abilità speciale",options:f,value:b.value},allowInspiration:!!((L=i==null?void 0:i.data)!=null&&L.inspiration)&&k,weakPoints:Number((C=(x=i==null?void 0:i.data)==null?void 0:x.hp)==null?void 0:C.weak_points)||0,characterId:i.id})})),e.querySelectorAll("[data-edit-resource]").forEach(d=>d.addEventListener("click",()=>{const m=B.find(f=>f.id===d.dataset.editResource);m&&aa(i,()=>z(e),m)})),e.querySelectorAll("[data-roll-hit-dice]").forEach(d=>d.addEventListener("click",async()=>{await bs(i,e)})),e.querySelectorAll("[data-roll-attack]").forEach(d=>d.addEventListener("click",m=>{m.target.closest("button")||ps(d.dataset.rollAttack)})),e.querySelectorAll("[data-cycle-weapon-mode]").forEach(d=>d.addEventListener("click",()=>{if(!i)return;const m=d.dataset.cycleWeaponMode,f=g==null?void 0:g.find(M=>String(M.id)===m||M.name===m);if(!f)return;const b=fa(f).filter(M=>M.damageDie);if(b.length<=1)return;const L=f.selected_damage_mode||b[0].id,x=Math.max(b.findIndex(M=>M.id===L),0),C=b[(x+1)%b.length];Ce(f.id,{selected_damage_mode:C.id}).then(M=>{const R=(te().cache.items||g||[]).map(W=>String(W.id)===String(f.id)?{...W,...M||{},selected_damage_mode:C.id}:W);return be("items",R),ye({items:R})}).then(()=>{A(`Modalità ${C.label}`),z(e)}).catch(()=>A("Errore cambio modalità arma","error"))})),e.querySelectorAll("[data-roll-damage]").forEach(d=>d.addEventListener("click",()=>{var M,R,W,G;if(!i)return;const m=d.dataset.rollDamage;if(!m)return;if(m.startsWith("wildshape:")){const j=Number(m.replace("wildshape:",""))||0,H=De(i,q),U=(M=H==null?void 0:H.statBlock.attacks)==null?void 0:M[j],ie=String((U==null?void 0:U.damage)||"").trim();if(!ie||ie==="-"){A("Danni non configurati per questo attacco","error");return}he({keepOpen:!0,title:`${H.companion.name} · Danni ${U.name||"Attacco"}`,mode:"generic",notation:ie,modifier:Number(U.damage_modifier)||0,rollType:"DMG",characterId:i==null?void 0:i.id,historyLabel:`${H.companion.name} · ${U.name||"Danni"}`});return}if(m.startsWith("spell:")){const j=m.replace("spell:",""),U=(Array.isArray((R=i.data)==null?void 0:R.spells)?i.data.spells:[]).find(le=>le.id===j);if(!U)return;const ie=Number(U.cast_level??U.level)||0,ee=Fe(U,ie);if(!ee){A("Danno non calcolabile per questo trucchetto.","error");return}he({keepOpen:!0,title:ee.title,mode:"generic",notation:ee.notation,modifier:ee.modifier,rollType:"DMG",characterId:i==null?void 0:i.id,historyLabel:U.name||null,sneakAttackDice:((W=i==null?void 0:i.data)==null?void 0:W.sneak_attack_dice)||null});return}const f=m.startsWith("weapon:")?m.split(":"):[null,m,"default"],b=f[1]||m,L=f[2]||"default",x=g==null?void 0:g.find(j=>String(j.id)===b||j.name===b);if(!x)return;const C=dt(i,x,L);if(!C){A("Danno non calcolabile per questa arma.","error");return}he({keepOpen:!0,title:C.title,mode:"generic",notation:C.notation,modifier:C.modifier,rollType:"DMG",characterId:i==null?void 0:i.id,historyLabel:x.name||null,sneakAttackDice:((G=i==null?void 0:i.data)==null?void 0:G.sneak_attack_dice)||null})}));const Z=d=>{var b;const m=(b=d==null?void 0:d.damage_dice_notation)==null?void 0:b.trim();if(!m)return;const f=ut(m);if(!(f!=null&&f.notation)){A("Notazione dado non valida per questa risorsa","error");return}he({keepOpen:!0,title:d.name||"Tiro abilità",mode:"generic",notation:f.notation,modifier:Number(d.damage_modifier)||0,rollType:"GEN",characterId:i==null?void 0:i.id,historyLabel:d.name||null})},ue=async d=>{const m=Number(d.max_uses)||0;if(!(!m||d.used>=m))try{await Ie(d.id,{used:Math.min(d.used+1,m)}),A("Risorsa usata"),ra(i)&&Z(d),z(e)}catch{A("Errore utilizzo risorsa","error")}};e.querySelectorAll("[data-resource-card]").forEach(d=>{const m=async f=>{if(f.target.closest("button"))return;const b=B.find(L=>L.id===d.dataset.resourceCard);b&&$t(b,{onUse:()=>ue(b),onReset:async()=>{try{await Ie(b.id,{used:0}),A("Risorsa ripristinata"),z(e)}catch{A("Errore ripristino risorsa","error")}},onRecover:async()=>{try{await Ie(b.id,{used:Math.max((Number(b.used)||0)-1,0)}),A("Carica recuperata"),z(e)}catch{A("Errore recupero carica","error")}}})};d.addEventListener("click",m)}),e.querySelectorAll("[data-use-resource]").forEach(d=>d.addEventListener("click",async()=>{const m=B.find(f=>f.id===d.dataset.useResource);m&&await ue(m)})),e.querySelectorAll("[data-use-spell]").forEach(d=>d.addEventListener("click",async()=>{var W,G;if(!i)return;const m=d.dataset.useSpell;if(!m)return;const b=(Array.isArray((W=i.data)==null?void 0:W.spells)?i.data.spells:[]).find(j=>j.id===m);if(!b||(Number(b.level)||0)<1)return;const x=await Qt(i,b);if(!x||!await sa(i,x,()=>z(e)))return;const M=te().characters.find(j=>fe(j.id)===fe(i.id))||i;if(b.concentration){const j=M.data||{};j.concentration_active||await J(M,{...j,concentration_active:!0},"Concentrazione attiva",()=>z(e))}if(!ra(M)){z(e);return}const R=Fe(b,x);if(!R){A("Danno non calcolabile per questo incantesimo.","error");return}he({keepOpen:!0,title:R.title,mode:"generic",notation:R.notation,modifier:R.modifier,rollType:"DMG",characterId:i.id,historyLabel:b.name||null,sneakAttackDice:((G=i==null?void 0:i.data)==null?void 0:G.sneak_attack_dice)||null})})),e.querySelectorAll("[data-consume-spell-slot]").forEach(d=>d.addEventListener("click",async()=>{if(!i)return;const m=Number(d.dataset.consumeSpellSlot);!Number.isFinite(m)||m<1||await sa(i,m,()=>z(e))})),e.querySelectorAll("[data-restore-spell-slot]").forEach(d=>d.addEventListener("click",async()=>{if(!i)return;const m=Number(d.dataset.restoreSpellSlot);!Number.isFinite(m)||m<1||await kt(i,m,()=>z(e))})),e.querySelectorAll("[data-delete-resource]").forEach(d=>d.addEventListener("click",async()=>{const m=B.find(b=>b.id===d.dataset.deleteResource);if(!(!m||!await je({title:"Conferma eliminazione risorsa",message:`Stai per eliminare la risorsa "${m.name}". Questa azione non può essere annullata.`,confirmLabel:"Elimina"})))try{await za(m.id),A("Risorsa eliminata"),z(e)}catch{A("Errore eliminazione risorsa","error")}})),e.querySelectorAll("[data-death-save]").forEach(d=>d.addEventListener("click",async()=>{if(!i||!k)return;const{deathSave:m,deathSaveIndex:f}=d.dataset,b=Number(f);if(!m||!b)return;const L=i.data||{},x=L.death_saves||{},C=Math.max(0,Math.min(3,Number(x[m])||0)),M=b===C?C-1:b,R={successes:Math.max(0,Math.min(3,m==="successes"?M:Number(x.successes)||0)),failures:Math.max(0,Math.min(3,m==="failures"?M:Number(x.failures)||0))};await J(i,{...L,death_saves:R},"Tiri salvezza contro morte aggiornati",()=>z(e))})),e.querySelectorAll("[data-weakness-level]").forEach(d=>d.addEventListener("click",async()=>{if(!i||!k)return;const m=Number(d.dataset.weaknessLevel);if(!m)return;const f=i.data||{},b=f.hp||{},L=Math.max(0,Math.min(6,Number(b.weak_points)||0));await J(i,{...f,hp:{...b,weak_points:m===L?0:m}},"Punti indebolimento aggiornati",()=>z(e))}));const Y=e.querySelector(".character-avatar");Y&&(Y.setAttribute("draggable","false"),Y.addEventListener("click",d=>{d.preventDefault(),wt(i)}),Y.addEventListener("contextmenu",d=>{d.preventDefault()}),Y.addEventListener("dragstart",d=>{d.preventDefault()})),e.querySelectorAll("[data-item-image]").forEach(d=>{d.setAttribute("draggable","false"),d.addEventListener("click",m=>{m.preventDefault(),m.stopPropagation();const f=g==null?void 0:g.find(b=>String(b.id)===d.dataset.itemImage);f&&Xe(f)})}),e.querySelectorAll("[data-item-preview]").forEach(d=>{d.addEventListener("click",m=>{m.preventDefault(),m.stopPropagation();const f=g==null?void 0:g.find(b=>String(b.id)===d.dataset.itemPreview);f&&Xe(f)})}),Wt(e,a)}finally{Ye(!1)}}function Ms(){ha()}function ha(){la||(document.addEventListener("click",async e=>{if(!e.target.closest("[data-actions-fab]"))return;const t=e.target.closest("[data-hp-action]"),s=e.target.closest("[data-money-action]"),n=e.target.closest("[data-rest]"),o=e.target.closest("[data-open-dice]"),r=e.target.closest("[data-add-loot]"),l=e.target.closest("[data-edit-conditions]"),c=e.target.closest("[data-edit-resistances]"),u=e.target.closest("[data-edit-roll-adjustments]");if(!t&&!s&&!n&&!o&&!r&&!l&&!c&&!u)return;e.preventDefault(),Xt();const p=Te??null;if(t){await gs(t.dataset.hpAction,p);return}if(s){if((window.location.hash.replace("#/","")||"home")==="inventory")return;await is(s.dataset.moneyAction,p);return}if(n){await fs(n.dataset.rest,p);return}if(o){Ca(o.dataset.openDice);return}if(r){await ns();return}if(l){await _a(p);return}if(c){await ss(p);return}u&&await es(p)}),la=!0)}function Xt(){const e=document.querySelector("[data-actions-fab]"),a=document.querySelector("[data-actions-toggle]");!e||!e.classList.contains("is-open")||(e.classList.remove("is-open"),a==null||a.setAttribute("aria-expanded","false"))}function de(){const e=te(),{user:a,offline:t,characters:s,activeCharacterId:n}=e,o=fe(n),r=s.find(u=>fe(u.id)===o),l=e.cache.companions||[],c=Ke(r,l);return{activeCharacter:r,sheetCharacter:c,companions:l,canEditCharacter:!!a&&!t}}async function _a(e){const{activeCharacter:a,canEditCharacter:t}=de();if(!a||!t)return;const s=await ft(a);if(!s)return;const n=s.getAll("conditions");await J(a,{...a.data,conditions:n},"Condizioni aggiornate",()=>{e&&z(e)})}function Yt(e){var t;const a=((t=e==null?void 0:e.data)==null?void 0:t.roll_adjustments)||{};return{attack_rolls:a.attack_rolls||{},saving_throws:a.saving_throws||{},skills:a.skills||{}}}function Jt(e){const a=Yt(e),t=te().cache.items||[],s=document.createElement("div");s.className="modal-form-grid compact-settings-form compact-settings-form--rolls";const n=[{value:"",label:"Nessuno"},{value:"advantage",label:"Vantaggio"},{value:"disadvantage",label:"Svantaggio"}],o=(r,l,c)=>{const u=document.createElement("section");u.className="character-edit-section compact-settings-section",u.innerHTML=`<h4>${r}</h4><p class="muted compact-settings-help">Indica solo gli override manuali; gli effetti automatici restano visibili sotto la riga.</p>`;const p=document.createElement("div");p.className="compact-setting-grid compact-setting-grid--roll",c.forEach($=>{var S;const y=((S=a[l])==null?void 0:S[$.key])||{},i=Aa(e,t,l,$),E=pe(i).rollMode||"",w=i.length===1&&i[0].source||"",k=y.mode||E,B=y.source||w,g=document.createElement("div");g.className="compact-setting-row compact-setting-row--roll";const q=document.createElement("label");q.className="field compact-setting-field";const v=document.createElement("span");v.textContent=$.label;const T=Re(n,k);T.name=`roll_${l}_${$.key}_mode`,q.append(v,T);const F=document.createElement("label");F.className="field compact-setting-field";const h=document.createElement("span");h.textContent="Fonte manuale";const N=Re(ya,B);if(N.name=`roll_${l}_${$.key}_source`,F.append(h,N),g.append(q,F),i.length){const _=document.createElement("p");_.className="muted compact-setting-note",_.textContent=`Automatico: ${i.map(D=>D.reason).join(" ")}`,g.appendChild(_)}p.appendChild(g)}),u.appendChild(p),s.appendChild(u)};return o("Tiri per colpire","attack_rolls",ka(e,t)),o("Tiri salvezza","saving_throws",Be),o("Abilità","skills",ze),s}function Zt(e,a){const t=te().cache.items||[],s={attack_rolls:{},saving_throws:{},skills:{}};return[{scope:"attack_rolls",entries:ka(a,t)},{scope:"saving_throws",entries:Be},{scope:"skills",entries:ze}].forEach(({scope:n,entries:o})=>{o.forEach(r=>{var i,E;const l=((i=e.get(`roll_${n}_${r.key}_mode`))==null?void 0:i.toString())||"",c=((E=e.get(`roll_${n}_${r.key}_source`))==null?void 0:E.toString().trim())||"",u=Aa(a,t,n,r),p=pe(u).rollMode||"",$=u.length===1&&u[0].source||"";(l==="advantage"||l==="disadvantage")&&!(l===p&&c===$)&&(s[n][r.key]={mode:l,source:c})})}),s}async function es(e){const{activeCharacter:a,canEditCharacter:t}=de();if(!a||!t)return;const s=await ce({title:"Vantaggi / Svantaggi situazionali",submitLabel:"Salva",content:Jt(a),cardClass:"modal-card--wide"});s&&await J(a,{...a.data,roll_adjustments:Zt(s,a)},"Vantaggi/svantaggi aggiornati",()=>{e&&z(e)})}function as(e){var n;const a=((n=e==null?void 0:e.data)==null?void 0:n.damage_defenses)||{},t=Se.reduce((o,r)=>{const l=r.group||"Altro";return o[l]||(o[l]=[]),o[l].push(r),o},{}),s=document.createElement("div");return s.className="modal-form-grid compact-settings-form compact-settings-form--defenses",s.innerHTML=Object.entries(t).map(([o,r])=>`
  ...
  `).join(""),s}function ts(e){return{resistances:Se.filter(a=>e.has(`damage_resistance_${a.key}`)).map(a=>a.key),immunities:Se.filter(a=>e.has(`damage_immunity_${a.key}`)).map(a=>a.key)}}async function ss(e){const{activeCharacter:a,canEditCharacter:t}=de();if(!a||!t)return;const s=await ce({title:"Resistenze & Immunità",submitLabel:"Salva",content:as(a),cardClass:"modal-card--wide"});s&&await J(a,{...a.data,damage_defenses:ts(s)},"Resistenze aggiornate",()=>{e&&z(e)})}async function ns(e){const{activeCharacter:a}=de(),t=te();if(!a)return;if(t.offline){A("Loot disponibile solo online.","error");return}const n=ma(a)==="kg"?"0.1":"1",o=await ce({title:"Aggiungi loot rapido",submitLabel:"Aggiungi",content:Ya(n),onOpen:({fieldsEl:r})=>{et(r)}});if(o)try{await Ga({user_id:a.user_id,character_id:a.id,name:o.get("name"),qty:Number(o.get("qty")),weight:Number(o.get("weight")),volume:Number(o.get("volume"))||0,value_cp:Number(o.get("value_cp")),category:"loot",equipable:!1,equip_slot:null,equip_slots:[],sovrapponibile:!1,is_magic:!1,max_volume:null}),A("Loot aggiunto")}catch{A("Errore loot","error")}}function Pe(e,{min:a=null,max:t=null}={}){if(!(e instanceof HTMLInputElement)||e.type!=="number"||e.closest(".modal-value-stepper"))return;const s=document.createElement("div");s.className="number-stepper modal-value-stepper";const n=document.createElement("button");n.type="button",n.className="number-stepper__button modal-value-stepper__button",n.textContent="−",n.setAttribute("aria-label","Diminuisci valore");const o=document.createElement("button");o.type="button",o.className="number-stepper__button modal-value-stepper__button",o.textContent="+",o.setAttribute("aria-label","Aumenta valore");const r=e.parentNode;if(!r)return;r.insertBefore(s,e),s.append(n,e,o);const l=u=>Number.isFinite(u)?u:0,c=u=>{const p=l(e.valueAsNumber),$=Number(e.step),y=Number.isFinite($)&&$>0?$:1;let i=p+y*u;const E=a??(e.min!==""?Number(e.min):null),w=t??(e.max!==""?Number(e.max):null);Number.isFinite(E)&&(i=Math.max(E,i)),Number.isFinite(w)&&(i=Math.min(w,i)),e.value=String(i),e.dispatchEvent(new Event("input",{bubbles:!0})),e.dispatchEvent(new Event("change",{bubbles:!0}))};n.addEventListener("click",()=>c(-1)),o.addEventListener("click",()=>c(1))}async function is(e,a){const{activeCharacter:t,canEditCharacter:s}=de();if(!t)return;if(!s){A("Azioni denaro disponibili solo con profilo online","error");return}const n=te();let o=n.cache.wallet;if(!o&&!n.offline)try{o=await Oa(t.id),be("wallet",o),o&&await ye({wallet:o})}catch{A("Errore caricamento wallet","error")}const c=await ce({title:e==="pay"?"Paga monete":"Ricevi monete",submitLabel:e==="pay"?"Paga":"Ricevi",content:Wa({direction:e}),onOpen:({fieldsEl:w})=>{const k=w==null?void 0:w.querySelector('input[name="amount"]');k&&Pe(k,{min:0})}});if(!c)return;o||(o={user_id:t.user_id,character_id:t.id,cp:0,sp:0,gp:0,pp:0});const u=c.get("coin"),p=Number(c.get("amount")||0),$={cp:u==="cp"?p:0,sp:u==="sp"?p:0,gp:u==="gp"?p:0,pp:u==="pp"?p:0},y=e==="pay"?-1:1,i=Object.fromEntries(Object.entries($).map(([w,k])=>[w,k*y])),E=Va(o,i);try{const w=await Ua({...E,user_id:o.user_id,character_id:o.character_id});await Ka({user_id:o.user_id,character_id:o.character_id,direction:e,amount:i,reason:c.get("reason"),occurred_on:c.get("occurred_on")}),be("wallet",w),await ye({wallet:w}),A("Wallet aggiornato"),a&&z(a)}catch{A("Errore aggiornamento denaro","error")}}const os=ua.reduce((e,a)=>(e[a.key]=a.label,e),{}),ca={advantage:["invisibile"],disadvantage:["accecato","avvelenato","intralciato","prono","spaventato"]},da={disadvantage:{dex:["intralciato"]},autoFail:{str:["paralizzato","privo_di_sensi","stordito"],dex:["paralizzato","privo_di_sensi","stordito"]}},ya=[{value:"",label:"Seleziona fonte"},{value:"situational",label:"Situazionale"},{value:"effect",label:"Effetto temporaneo"},{value:"condition",label:"Condizione"},{value:"armor",label:"Armatura"},{value:"racial",label:"Abilità razziale"},{value:"class",label:"Privilegio di classe"},{value:"spell",label:"Incantesimo"},{value:"item",label:"Oggetto magico/equipaggiamento"},{value:"other",label:"Altro"}];function Ne(e){const a=(e==null?void 0:e.data)||{};return Array.isArray(a.conditions)?a.conditions:a.condition?[a.condition]:[]}function Ae(e){return e.map(a=>os[a]||a).filter(Boolean)}function $a(e=[]){return(e||[]).some(a=>a.category==="armor"&&a.armor_type==="heavy"&&a.equipable&&ge(a).length)}function ka(e,a=[]){const t=(e==null?void 0:e.data)||{},n=(a||[]).filter(p=>p.category==="weapon"&&p.equipable&&ge(p).length).map(p=>({key:`weapon:${p.id??p.name}`,label:p.name||"Arma"})),r=(Array.isArray(t.spells)?t.spells:[]).filter(p=>(p.kind==="cantrip"||Number(p.level)===0)&&p.attack_roll&&p.damage_die).map(p=>({key:`spell:${p.id}`,label:p.name||"Incantesimo"})),u=!!((t.spellcasting||{}).ability&&X(t.proficiency_bonus)!==null)?[{key:"spell-attack",label:"Incantesimi"}]:[];return[...n,...r,...u]}function Ge(e){const a=Ne(e),t=ca.advantage.filter(o=>a.includes(o)),s=ca.disadvantage.filter(o=>a.includes(o)),n=[];return t.length&&n.push({mode:"advantage",source:"condition",reason:`Vantaggio: condizioni ${Ae(t).join(", ")}.`}),s.length&&n.push({mode:"disadvantage",source:"condition",reason:`Svantaggio: condizioni ${Ae(s).join(", ")}.`}),n}function wa(e,a,t){const n=Ne(e).includes("avvelenato")?["avvelenato"]:[],o=$a(a),r=[];return n.length&&r.push({mode:"disadvantage",source:"condition",reason:`Svantaggio: condizioni ${Ae(n).join(", ")}.`}),t.key==="stealth"&&o&&r.push({mode:"disadvantage",source:"armor",reason:"Svantaggio automatico: armatura pesante su Furtività."}),r}function ls(e,a,t){const n=Ne(e).includes("avvelenato")?["avvelenato"]:[],o=$a(a),r=[];return n.length&&r.push({mode:"disadvantage",source:"condition",reason:`Svantaggio: condizioni ${Ae(n).join(", ")}.`}),t==="dex"&&o&&r.push({mode:"disadvantage",source:"armor",reason:"Svantaggio automatico: armatura pesante su tiri speciali basati su DES."}),r}function Sa(e,a){const t=Ea(Ne(e),a.key);return t.rollMode?[{mode:t.rollMode,source:"condition",reason:t.rollModeReason}]:[]}function Aa(e,a,t,s){return t==="attack_rolls"?Ge(e):t==="skills"?wa(e,a,s):t==="saving_throws"?Sa(e,s):[]}function rs(e){var a;return((a=ya.find(t=>t.value===e))==null?void 0:a.label)||e}function ke(e,a,t,s){var c,u,p,$;const n=(p=(u=(c=e==null?void 0:e.data)==null?void 0:c.roll_adjustments)==null?void 0:u[a])==null?void 0:p[t];if(!n||n.mode!=="advantage"&&n.mode!=="disadvantage")return null;const o=n.mode==="advantage"?"Vantaggio":"Svantaggio",r=($=n.source)==null?void 0:$.toString().trim(),l=r?rs(r):"Situazionale";return{mode:n.mode,reason:`${o}: ${s} (${l}).`}}function pe(e){const a=e.filter(Boolean),t=a.filter(n=>n.mode==="advantage").map(n=>n.reason).filter(Boolean),s=a.filter(n=>n.mode==="disadvantage").map(n=>n.reason).filter(Boolean);return t.length&&s.length?{rollMode:null,rollModeReason:`Vantaggio e svantaggio si annullano. ${[...t,...s].join(" ")}`}:t.length?{rollMode:"advantage",rollModeReason:t.join(" ")}:s.length?{rollMode:"disadvantage",rollModeReason:s.join(" ")}:{rollMode:null,rollModeReason:null}}function Ea(e,a){const s=(da.autoFail[a]||[]).filter(r=>e.includes(r));if(s.length)return{disabled:!0,disabledReason:`Condizioni: ${Ae(s).join(", ")}`};const o=(da.disadvantage[a]||[]).filter(r=>e.includes(r));return o.length?{rollMode:"disadvantage",rollModeReason:`Svantaggio: condizioni ${Ae(o).join(", ")}.`}:{}}function Ma(e,a=[]){const t=e.data||{},s=t.abilities||{},n=X(t.proficiency_bonus),o=t.skills||{},r=t.skill_mastery||{};return ze.map(l=>{const c=!!o[l.key],u=!!r[l.key],p=Ee(s[l.ability],n,c?u?2:1:0),$=p??0,y=wa(e,a,l);y.push(ke(e,"skills",l.key,l.label));const i=pe(y);return{value:l.key,label:`${l.label} (${V(p)})`,shortLabel:l.label,modifier:$,rollMode:i.rollMode,rollModeReason:i.rollModeReason}})}function La(e,a=[]){const t=e.data||{},s=t.abilities||{},n=X(t.proficiency_bonus),o=Array.isArray(t.special_skill_rolls)?t.special_skill_rolls:[];return(o.some(c=>{const u=String((c==null?void 0:c.id)??"").toLowerCase(),p=String((c==null?void 0:c.name)??"").trim().toLowerCase();return u==="initiative"||u==="default_initiative"||p==="iniziativa"})?o:[{id:"default_initiative",name:"Iniziativa",ability:"dex",proficient:!1,mastery:!1,bonus:0},...o]).map((c,u)=>{var q;const p=oe[c.ability]?c.ability:"str",$=!!c.proficient,y=!!c.mastery&&$,i=Ee(s[p],n,$?y?2:1:0),E=Number(c.bonus)||0,w=(i??0)+E,k=((q=c.name)==null?void 0:q.trim())||`Tiro speciale ${u+1}`,B=ls(e,a,p),g=pe(B);return{value:String(c.id??u),label:`${k} (${V(w)})`,shortLabel:k,modifier:w,rollMode:g.rollMode,rollModeReason:g.rollModeReason}})}function Qe(e){const a=e.data||{},t=a.abilities||{},s=X(a.proficiency_bonus),n=a.saving_throws||{},o=Ne(e);return Be.map(r=>{const l=!!n[r.key],c=Ee(t[r.key],s,l?1:0),u=c??0,p=Ea(o,r.key),$=ke(e,"saving_throws",r.key,r.label),y=p.disabled?{rollMode:null,rollModeReason:null}:pe([...Sa(e,r),$]),i=p.disabled?" · fallimento diretto":"";return{value:r.key,label:`${r.label} (${V(c)})${i}`,shortLabel:oe[r.key]||r.label,modifier:u,rollMode:y.rollMode,rollModeReason:y.rollModeReason,disabled:p.disabled||!1,disabledReason:p.disabledReason||null}})}function Na(e,a=[],t=[]){var q;const s=e.data||{},n=Number(s.attack_bonus_melee??s.attack_bonus)||0,o=Number(s.attack_bonus_ranged??s.attack_bonus)||0,r=(a||[]).filter(v=>v.category==="weapon"&&v.equipable&&ge(v).length),l=X(s.proficiency_bonus)??0,c=s.proficiencies||{},u=Ge(e),p=r.map(v=>{var K;const T=v.weapon_range||(v.range_normal?"ranged":"melee"),F=v.attack_ability||(T==="ranged"?"dex":"str"),h=me((K=s.abilities)==null?void 0:K[F])??0,S=(v.weapon_type==="simple"?!!c.weapon_simple:v.weapon_type==="martial"?!!c.weapon_martial:!1)?l:0,_=T==="ranged"?o:n,D=h+S+(Number(v.attack_modifier)||0)+_,I=`weapon:${v.id??v.name}`,O=pe([...u,ke(e,"attack_rolls",I,v.name)]);return{value:I,label:`${v.name} (${V(D)})`,shortLabel:v.name,modifier:D,rollMode:O.rollMode,rollModeReason:O.rollModeReason}}),$=De(e,t);$!=null&&$.statBlock.attacks.length&&$.statBlock.attacks.forEach((v,T)=>{const F=`wildshape:${T}`,h=pe([...u,ke(e,"attack_rolls",F,v.name||`Attacco ${T+1}`)]);p.push({value:F,label:`${v.name||`Attacco ${T+1}`} (${V(v.to_hit||0)})`,shortLabel:v.name||`Attacco ${T+1}`,modifier:Number(v.to_hit)||0,rollMode:h.rollMode,rollModeReason:h.rollModeReason})});const i=(s.spellcasting||{}).ability,E=i?(q=s.abilities)==null?void 0:q[i]:null,w=me(E),k=w===null||l===null?null:w+l,g=(Array.isArray(s.spells)?s.spells:[]).filter(v=>(v.kind==="cantrip"||Number(v.level)===0)&&v.attack_roll&&v.damage_die);return i&&k!==null&&g.forEach(v=>{const T=`spell:${v.id}`,F=pe([...u,ke(e,"attack_rolls",T,v.name)]);p.push({value:T,label:`${v.name} (${V(k)})`,shortLabel:v.name,modifier:k,rollMode:F.rollMode,rollModeReason:F.rollModeReason})}),p}function cs(e){var p;const a=e.data||{},t=X(a.proficiency_bonus),n=(a.spellcasting||{}).ability,o=n?(p=a.abilities)==null?void 0:p[n]:null,r=me(o);if(!n||r===null||t===null)return[];const l=r+t,c="spell-attack",u=pe([...Ge(e),ke(e,"attack_rolls",c,"Incantesimi")]);return[{value:c,label:`Incantesimi (${V(l)})`,shortLabel:"Incantesimi",modifier:l,rollMode:u.rollMode,rollModeReason:u.rollModeReason}]}function Oe(e){var a;return((a=Se.find(t=>t.key===e))==null?void 0:a.label)||e}function ds(e,a,t){var l;const s=Math.max(Number(a)||0,0);if(!t)return{amount:s,reason:null};const n=((l=e==null?void 0:e.data)==null?void 0:l.damage_defenses)||{},o=Array.isArray(n.resistances)?n.resistances:[],r=Array.isArray(n.immunities)?n.immunities:[];return r.includes("all")||r.includes(t)?{amount:0,reason:`immunità a ${Oe(t)}`}:o.includes("all")||o.includes(t)?{amount:Math.floor(s/2),reason:`resistenza a ${Oe(t)}`}:{amount:s,reason:null}}function xa(e,a){if(!(a!=null&&a.consumes_ammunition))return null;const t=a.required_ammunition_type||a.ammunition_type;return(e||[]).filter(s=>s.id!==a.id).filter(s=>s.category!=="container").filter(s=>!t||s.ammunition_type===t).filter(s=>Number(s.qty)>0).sort((s,n)=>String(s.name||"").localeCompare(String(n.name||""),"it",{sensitivity:"base"}))[0]||null}async function us(e,a){const t=xa(e,a);if(!t)return!1;const s=Math.max((Number(t.qty)||0)-1,0),n=await Ce(t.id,{qty:s}),r=(te().cache.items||[]).map(l=>String(l.id)===String(t.id)?{...l,...n||{},qty:s}:l);return be("items",r),await ye({items:r}),A(`${t.name} consumato (${s} rimasti)`),!0}function ps(e){var $,y,i;const{activeCharacter:a,sheetCharacter:t,canEditCharacter:s,companions:n}=de();if(!a||!e)return;const o=te().cache.items||[],r=Na(t||a,o,n),l=r.find(E=>E.value===e);if(!l)return;const c=e.startsWith("weapon:")?e.replace("weapon:",""):null,u=c?o.find(E=>String(E.id)===c||E.name===c):null;if(u!=null&&u.consumes_ammunition&&!xa(o,u)){A("Munizioni esaurite o non disponibili per questa arma.","error");return}let p=!1;we({title:`Tiro per Colpire • ${l.shortLabel||l.label}`,mode:"d20",rollType:"TC",selection:{label:"Attacco",options:r,value:l.value},allowInspiration:!!(($=a==null?void 0:a.data)!=null&&$.inspiration)&&s,weakPoints:Number((i=(y=a==null?void 0:a.data)==null?void 0:y.hp)==null?void 0:i.weak_points)||0,characterId:a.id,historyLabel:l.shortLabel||l.label,onRollComplete:async()=>{if(!(!(u!=null&&u.consumes_ammunition)||p)){p=!0;try{await us(te().cache.items||o,u)}catch{A("Errore consumo munizioni","error")}}}})}function Ca(e){var $,y,i,E,w;const{activeCharacter:a,sheetCharacter:t,companions:s,canEditCharacter:n}=de(),o=te().cache.items||[],r=!!(($=a==null?void 0:a.data)!=null&&$.inspiration)&&n,l=Number((i=(y=a==null?void 0:a.data)==null?void 0:y.hp)==null?void 0:i.weak_points)||0,c=r&&a?async()=>{const k=a.data||{};k.inspiration&&await J(a,{...k,inspiration:!1},"Ispirazione consumata",Te?()=>z(Te):null)}:null,p={"saving-throws":{title:"Tiro Salvezza",mode:"d20",rollType:"TS",selection:a?{label:"Tiro salvezza",options:Qe(t||a)}:null},skills:{title:"Tiro Abilità",mode:"d20",rollType:"TA",selection:a?{label:"Abilità",options:Ma(t||a,o)}:null},"special-skills":{title:"Tiro Abilità Speciale",mode:"d20",rollType:"TA",selection:a?{label:"Abilità speciale",options:La(t||a,o)}:null},"attack-roll":{title:"Tiro per Colpire",mode:"d20",rollType:"TC",selection:a?{label:"Attacco",options:Na(t||a,o,s)}:null},"spell-attack":{title:"Tiro per Colpire Incantesimi",mode:"d20",rollType:"TC",selection:a?{label:"Incantesimi",options:cs(a)}:null},roller:{title:"Lancia Dadi generico",mode:"generic",rollType:"GEN"}}[e]??{title:"Lancia dadi",mode:"generic"};if(e==="spell-attack"&&!((w=(E=p.selection)==null?void 0:E.options)!=null&&w.length)){A("Configura abilità da incantatore e bonus competenza per usare questo tiro.","error");return}we({...p,allowInspiration:r,onConsumeInspiration:c,weakPoints:l,characterId:a==null?void 0:a.id})}async function ms(e,a=[],t=null){var p,$;const s=Array.isArray((p=e==null?void 0:e.data)==null?void 0:p.weapon_masteries)?e.data.weapon_masteries:[];if(!(!!(($=e==null?void 0:e.data)!=null&&$.weapon_mastery_enabled)||s.length>0))return;const o=[...new Set((a||[]).filter(y=>y.category==="weapon"&&y.weapon_mastery).map(y=>y.weapon_mastery))];if(!o.length)return;const r=document.createElement("div");r.className="drawer-form modal-form-grid",r.innerHTML=`

import{j as dt,n as Ut}from"./index-_fTQz7em.js";let Te=null;const Kt=["/dungeons-dragons-app/libs/three.min.js","/dungeons-dragons-app/libs/cannon.min.js","/dungeons-dragons-app/libs/teal.js","/dungeons-dragons-app/dice-roller/dice.js","/dungeons-dragons-app/dice-roller/main.js"];function Jt(i){return new Promise((l,r)=>{const c=document.querySelector(`script[data-legacy-dice="${i}"]`);if((c==null?void 0:c.dataset.loaded)==="true")return l();if(c){c.addEventListener("load",()=>l(),{once:!0}),c.addEventListener("error",()=>r(new Error(`Impossibile caricare ${i}`)),{once:!0});return}const p=document.createElement("script");p.src=i,p.async=!1,p.dataset.legacyDice=i,p.addEventListener("load",()=>{p.dataset.loaded="true",l()},{once:!0}),p.addEventListener("error",()=>r(new Error(`Impossibile caricare ${i}`)),{once:!0}),document.body.appendChild(p)})}function Yt(){return window.main&&typeof window.main.init=="function"?Promise.resolve():(Te||(Te=Kt.reduce((i,l)=>i.then(()=>Jt(l)),Promise.resolve())),Te)}let a=null,H=null,Z=0,ut=!1;function Qt(){return`
